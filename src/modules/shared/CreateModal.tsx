...
const styles: Record<string, React.CSSProperties> = {
  ...
  panel: {
    ...
    maxHeight: "92vh",
    overflow: "auto",
    background: "var(--modal-panel-bg, #fff)",
    borderRadius: 18,
    border: "1px solid var(--modal-panel-border, rgba(148,163,184,0.24))",
  ...
  closeButton: {
    border: "1px solid var(--modal-close-border, rgba(148,163,184,0.4))",
    background: "var(--modal-close-bg, #fff)",
    color: "var(--modal-close-color, #0f172a)",
    borderRadius: 10,
    padding: "10px 14px",
    fontWeight: 700,
    cursor: "pointer",
