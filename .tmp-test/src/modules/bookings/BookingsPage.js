...
function BookingsPage({ currentUser, bookings, setBookings, intakeRecords, setIntakeRecords, inspectionRecords, setInspectionRecords, isCompactLayout, }) {
    ...
    const [form, setForm] = (0, react_1.useState)(() => bookingDraftInitial ? { ...getDefaultBookingForm(currentUser.fullName), ...bookingDraftInitial } : getDefaultBookingForm(currentUser.fullName));
    const [search, setSearch] = (0, react_1.useState)("");
    const [error, setError] = (0, react_1.useState)("");
    const [showDraftRestore, setShowDraftRestore] = (0, react_1.useState)(() => !!bookingDraftInitial);
