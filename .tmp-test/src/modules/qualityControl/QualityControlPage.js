...
function buildQcExportText(ro, qc) {
    return [
        ...
        "",
        qc
            ? `Latest QC: ${qc.qcNumber} | ${qc.result} | ${(0, helpers_1.formatDateTime)(qc.createdAt)} | By: ${qc.qcBy}`
        ...
        ro.workLines
            ...
            .map((line, index) => `${index + 1}. ${line.title} | ${line.status} | ${(0, helpers_1.formatCurrency)((0, helpers_1.parseMoneyInput)(line.totalEstimate))}`)
...
function QualityControlPage({ currentUser, repairOrders, setRepairOrders, qcRecords, setQcRecords, isCompactLayout, }) {
    ...
    const selectedApprovedLines = (0, react_1.useMemo)(() => (selectedRO ? selectedRO.workLines.filter((line) => (line.approvalDecision ?? "Pending") === "Approved") : []), [selectedRO]);
    const selectedCompletedApprovedCount = (0, react_1.useMemo)(() => selectedApprovedLines.filter((line) => line.status === "Completed").length, [selectedApprovedLines]);
    ...
    const history = (0, react_1.useMemo)(() => [...qcRecords]
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: (0, helpers_1.getResponsiveSpan)(4, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "QC Queue", subtitle: "Only jobs already moved to Quality Check", right: (0, jsx_runtime_1.jsxs)("span", { style: styles.statusWarning, children: [queue.length, " waiting"] }), children: !queue.length ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No repair orders are waiting for QC." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: queue.map((row) => {
                                ...
                                return ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: () => setSelectedRoId(row.id), style: {
                                    ...
                                    }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardTitle, children: row.roNumber }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardSubtitle, children: row.plateNumber || row.conductionNumber || "No plate" })] }), (0, jsx_runtime_1.jsx)("span", { style: getROStatusStyle(row.status), children: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardMeta, children: (0, jsx_runtime_1.jsx)("strong", { children: row.accountLabel }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileCardMeta, children: [row.make, " ", row.model, " ", row.year] })] }, row.id));
                            }) })) }) }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.gridItem, gridColumn: (0, helpers_1.getResponsiveSpan)(8, isCompactLayout) }, children: [(0, jsx_runtime_1.jsx)(Card, { title: "QC Form", subtitle: "Chief Technician / Senior Mechanic gate before release", right: selectedRO ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => printTextDocument(`QC ${selectedRO.roNumber}`, buildQcExportText(selectedRO, latestQcForSelected)), children: "Print QC" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => downloadTextFile(`${selectedRO.roNumber}_qc.txt`, buildQcExportText(selectedRO, latestQcForSelected)), children: "Export QC" }), canPerformQC ? (0, jsx_runtime_1.jsx)("span", { style: styles.statusOk, children: "QC Allowed" }) : (0, jsx_runtime_1.jsx)("span", { style: styles.statusLocked, children: "QC Locked" })] })) : canPerformQC ? ((0, jsx_runtime_1.jsx)("span", { style: styles.statusOk, children: "QC Allowed" })) : ((0, jsx_runtime_1.jsx)("span", { style: styles.statusLocked, children: "QC Locked" })), children: !selectedRO ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "Select a repair order from the QC queue." })) : ((0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "RO Number" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedRO.roNumber })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "Vehicle" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedRO.plateNumber || selectedRO.conductionNumber || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "Customer" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedRO.accountLabel })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "RO Created" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: (0, helpers_1.formatDateTime)(selectedRO.createdAt) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "Encoded By" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedRO.encodedBy || "-" })] }), selectedRO.updatedBy ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "Last Updated By" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedRO.updatedBy })] })) : (0, jsx_runtime_1.jsx)("div", { style: styles.summaryTile })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "Approved Lines" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedApprovedLines.length })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "Completed Approved" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedCompletedApprovedCount })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryTile, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.summaryLabel, children: "Outstanding" }), (0, jsx_runtime_1.jsx)("div", { style: styles.summaryValue, children: selectedOutstandingApprovedCount })] })] }), latestQcForSelected ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Latest QC Result" }), (0, jsx_runtime_1.jsxs)("strong", { children: [latestQcForSelected.qcNumber, " \u2022 ", latestQcForSelected.result, " \u2022 ", (0, helpers_1.formatDateTime)(latestQcForSelected.createdAt)] })] })) : ((0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Latest QC Result" }), (0, jsx_runtime_1.jsx)("strong", { children: "No prior QC record yet" })] })), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: checklistItems.map((item) => ((0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxCard, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: checks[item.key], disabled: !canPerformQC, onChange: (e) => setChecks((prev) => ({ ...prev, [item.key]: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: item.label })] }, item.key))) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "QC Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: { ...styles.textarea, minHeight: 120 }, value: notes, onChange: (e) => setNotes(e.target.value), disabled: !canPerformQC, placeholder: "Enter findings. Required when QC fails." })] }), error ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: error }) : null, (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.stickyActionBar : styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.smallButtonDanger, ...(isCompactLayout ? styles.actionButtonWide : {}) }, disabled: !canPerformQC, onClick: () => submitQC("Failed"), children: "Fail QC" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.smallButtonSuccess, ...(isCompactLayout ? styles.actionButtonWide : {}) }, disabled: !canPerformQC, onClick: () => submitQC("Passed"), children: "Pass QC" })] })] })) }), (0, jsx_runtime_1.jsx)("div", { style: { marginTop: 16 }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Recent QC History", subtitle: "Latest QC results", children: !history.length ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No QC history yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: history.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardTitle, children: row.qcNumber }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardSubtitle, children: row.roNumber })] }), (0, jsx_runtime_1.jsx)("span", { style: row.result === "Passed" ? styles.statusOk : styles.statusLocked, children: row.result })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileCardMeta, children: ["By: ", row.qcBy] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardMeta, children: (0, helpers_1.formatDateTime)(row.createdAt) }), row.notes ? (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardNote, children: row.notes }) : null] }, row.id))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "QC No." }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "RO" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Result" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "By" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Date" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Notes" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: history.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.qcNumber }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.roNumber }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: (0, jsx_runtime_1.jsx)("span", { style: row.result === "Passed" ? styles.statusOk : styles.statusLocked, children: row.result }) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.qcBy }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: (0, helpers_1.formatDateTime)(row.createdAt) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.notes || "-" })] }, row.id))) })] }) })) }) })] })] }) }));
}
