...
exports.normalizeMileageSuggestions = normalizeMileageSuggestions;
exports.normalizeLibrarySuggestions = normalizeLibrarySuggestions;
exports.getSuggestionSpecificityScore = getSuggestionSpecificityScore;
exports.dedupeSuggestionsByPurpose = dedupeSuggestionsByPurpose;
exports.filterAlreadyAddedSuggestions = filterAlreadyAddedSuggestions;
exports.groupSuggestionsByCategory = groupSuggestionsByCategory;
exports.getUnifiedMaintenanceSuggestions = getUnifiedMaintenanceSuggestions;
exports.default = App;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_1 = __importStar(require("react"));
const RolesPage_1 = __importDefault(require("./modules/roles/RolesPage"));
const HistoryPage_1 = __importDefault(require("./modules/history/HistoryPage"));
const SettingsPage_1 = __importDefault(require("./modules/settings/SettingsPage"));
const BookingsPage_1 = __importDefault(require("./modules/bookings/BookingsPage"));
const ReleasePage_1 = __importDefault(require("./modules/release/ReleasePage"));
const BackjobsPage_1 = __importDefault(require("./modules/backjobs/BackjobsPage"));
const PartsPage_1 = __importDefault(require("./modules/parts/PartsPage"));
const IntakePage_1 = __importDefault(require("./modules/intake/IntakePage"));
const QualityControlPage_1 = __importDefault(require("./modules/qualityControl/QualityControlPage"));
const helpers_1 = require("./modules/shared/helpers");
...
function normalizeMileageSuggestions(context) {
    return getMileageMaintenanceSuggestions(context.odometerKm);
}
function normalizeLibrarySuggestions(context) {
    return getRecommendationLibrarySuggestions(context);
}
function getSuggestionSpecificityScore(suggestion) {
    return getMaintenanceSpecificityRank(suggestion);
}
function dedupeSuggestionsByPurpose(suggestions) {
    return dedupeMaintenanceSuggestions(suggestions);
}
function filterAlreadyAddedSuggestions(suggestions, existingRecommendationTitles, existingWorkLineTitles, dismissedSuggestionIds = []) {
    return suggestions.filter((suggestion) => {
...
function getUnifiedMaintenanceSuggestions(context) {
    const normalized = [
...
class CustomerPortalErrorBoundary extends react_1.default.Component {
    state = {
        hasError: false,
        errorMessage: "",
    };
...
class AppErrorBoundary extends react_1.default.Component {
    ...
    render() {
        if (this.state.hasError) {
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: globalCss }), (0, jsx_runtime_1.jsx)("div", { style: styles.appShell, children: (0, jsx_runtime_1.jsx)("div", { style: styles.mainArea, children: (0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsx)("div", { style: styles.grid, children: (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsxs)(Card, { title: "App Recovery", subtitle: "Safe fallback", children: [(0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: "Something in the app failed to render." }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: this.state.errorMessage || "A record or screen state triggered a runtime error. Reload the app to continue." }), (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => window.location.reload(), children: "Reload App" }) })] }) }) }) }) }) })] }));
        }
        return this.props.children;
    }
}
...
function InspectionStatusBadge({ status }) {
    return (0, jsx_runtime_1.jsx)("span", { style: getInspectionStatusStyle(status), children: status });
}
function ROStatusBadge({ status }) {
    return (0, jsx_runtime_1.jsx)("span", { style: getROStatusStyle(status), children: status });
}
function WorkLineStatusBadge({ status }) {
    return (0, jsx_runtime_1.jsx)("span", { style: getWorkLineStatusStyle(status), children: status });
}
...
function BookingCalendarPicker({ value, onChange, }) {
    const dates = (0, react_1.useMemo)(() => getUpcomingBookingDates(14), []);
    return ((0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Calendar" }), (0, jsx_runtime_1.jsx)("div", { style: styles.calendarStrip, children: dates.map((item) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", style: {
                        ...styles.calendarDateButton,
                        ...(value === item.value ? styles.calendarDateButtonActive : {}),
                    }, onClick: () => onChange(item.value), children: [(0, jsx_runtime_1.jsx)("span", { style: styles.calendarWeekday, children: item.weekday }), (0, jsx_runtime_1.jsx)("strong", { children: item.label })] }, item.value))) })] }));
}
function LoginScreen({ audience, setAudience, staffForm, setStaffForm, staffError, onStaffSubmit, customerForm, setCustomerForm, customerError, onCustomerSubmit, supplierForm, setSupplierForm, supplierError, onSupplierSubmit, publicBookingForm, setPublicBookingForm, publicBookingError, onPublicBookingSubmit, isPublicBookingSubmitting, onQuickStaffLogin, onLoadDemoData, onOpenDemoCustomerPortal, }) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: styles.loginShell, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.loginPanel, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.loginBrand, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.brandLogo, children: "DVI" }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.loginTitle, children: "Workshop Management App" }), (0, jsx_runtime_1.jsx)("div", { style: styles.loginSubtitle, children: BUILD_VERSION })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                ...styles.secondaryButton,
                                ...(isStaff ? styles.portalTabActive : {}),
                            }, onClick: () => setAudience("staff"), children: "Staff Sign In" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                ...styles.secondaryButton,
                                ...(isCustomer ? styles.portalTabActive : {}),
                            }, onClick: () => setAudience("customer"), children: "Customer Portal" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                ...styles.secondaryButton,
                                ...(isBooking ? styles.portalTabActive : {}),
                            }, onClick: () => setAudience("booking"), children: "Book Service" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                ...styles.secondaryButton,
                                ...(!isStaff && !isCustomer && !isBooking ? styles.portalTabActive : {}),
                            }, onClick: () => setAudience("supplier"), children: "Supplier Portal" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.buildNoteBox, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.buildNoteTitle, children: isStaff ? "Staff Access" : isCustomer ? "Customer Portal Access" : isBooking ? "Book Service" : "Supplier Portal Access" }), (0, jsx_runtime_1.jsx)("div", { style: styles.buildNoteText, children: isStaff
                                ...
                                : isCustomer
                                    ...
                                    : isBooking
                                        ...
                                        : "Suppliers can enter their supplier name and submit bids into open parts requests without opening the staff dashboard." })] }), isStaff ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("form", { onSubmit: onStaffSubmit, style: styles.loginForm, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Username" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: staffForm.username, onChange: (e) => setStaffForm((prev) => ({ ...prev, username: e.target.value })), autoComplete: "username", placeholder: "Enter username" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Password" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, type: "password", value: staffForm.password, onChange: (e) => setStaffForm((prev) => ({ ...prev, password: e.target.value })), autoComplete: "current-password", placeholder: "Enter password" })] }), staffError ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: staffError }) : null, (0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.primaryButton, children: "Sign In" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.updateNoteBox, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.updateNoteTitle, children: "Latest Build Update" }), (0, jsx_runtime_1.jsx)("div", { style: styles.updateNoteText, children: "Phase 17K.1 refines the Inspection module with cleaner navigation, faster encoding cues, stronger edit visibility, and a clearer action layout while preserving the current full system branch." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoBox, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.demoTitle, children: "Quick Demo Access" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: onOpenDemoCustomerPortal, children: "Open Demo Customer Portal" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: onLoadDemoData, children: "Load Simulated Data" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("admin"), children: "Admin" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("advisor"), children: "Advisor" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("chieftech"), children: "Chief Tech" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("senior"), children: "Senior" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("mechanic"), children: "Mechanic" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("office"), children: "Office" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("reception"), children: "Reception" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => onQuickStaffLogin("ojt"), children: "OJT" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoGrid, children: [(0, jsx_runtime_1.jsx)("div", { children: "Admin instantly opens full access for testing." }), (0, jsx_runtime_1.jsx)("div", { children: "Load Simulated Data seeds intake, inspection, RO, approval, parts, invoice, payment, QC, release, and work-log records." }), (0, jsx_runtime_1.jsx)("div", { children: "Quick buttons still use your real in-app roles and permissions." })] })] })] })) : isCustomer ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("form", { onSubmit: onCustomerSubmit, style: styles.loginForm, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Phone or Email" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: customerForm.identifier, onChange: (e) => setCustomerForm((prev) => ({ ...prev, identifier: e.target.value })), autoComplete: "username", placeholder: "Enter phone number or email" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Password" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, type: "password", value: customerForm.password, onChange: (e) => setCustomerForm((prev) => ({ ...prev, password: e.target.value })), autoComplete: "current-password", placeholder: "Enter portal password" })] }), customerError ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: customerError }) : null, (0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.primaryButton, children: "Open Portal" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoBox, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.demoTitle, children: "Portal Starter Note" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoGrid, children: [(0, jsx_runtime_1.jsx)("div", { children: "Customer accounts are generated from intake and repair-order records." }), (0, jsx_runtime_1.jsx)("div", { children: "Default portal password uses the last 4 digits of the customer phone number." }), (0, jsx_runtime_1.jsx)("div", { children: "Sample portal login: Miguel Santos  -  09171234567 / 4567" }), (0, jsx_runtime_1.jsx)("div", { children: "Sample portal login: Andrea Lim  -  fleet@primemovers.example.com / 6543" }), (0, jsx_runtime_1.jsx)("div", { children: "Customers can review active jobs, see approval items, track progress, and browse their vehicles." })] })] })] })) : isBooking ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("form", { onSubmit: onPublicBookingSubmit, style: styles.loginForm, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Customer Name" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: publicBookingForm.customerName, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, customerName: e.target.value })), placeholder: "Enter full name" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Phone" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: publicBookingForm.phone, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, phone: e.target.value })), placeholder: "Enter phone number" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Email" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: publicBookingForm.email, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, email: e.target.value })), placeholder: "Enter email" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Plate Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: publicBookingForm.plateNumber, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, plateNumber: e.target.value.toUpperCase() })), placeholder: "ABC-1234" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Make" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: publicBookingForm.make, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, make: e.target.value })), placeholder: "Toyota" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Model" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: publicBookingForm.model, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, model: e.target.value })), placeholder: "Fortuner" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Year" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: publicBookingForm.year, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, year: e.target.value })), placeholder: "2021" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Preferred Date" }), (0, jsx_runtime_1.jsx)("input", { type: "date", style: styles.input, value: publicBookingForm.requestedDate, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, requestedDate: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Preferred Time" }), (0, jsx_runtime_1.jsx)("input", { type: "time", style: styles.input, value: publicBookingForm.requestedTime, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, requestedTime: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Service Type" }), (0, jsx_runtime_1.jsx)("select", { style: styles.select, value: publicBookingForm.serviceType, onChange: (e) => setPublicBookingForm((prev) => {
                                            ...
                                            }), children: BOOKING_SERVICE_OPTIONS.map((type) => ((0, jsx_runtime_1.jsx)("option", { value: type, children: type }, type))) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Service Detail" }), (0, jsx_runtime_1.jsx)("select", { style: styles.select, value: publicBookingForm.serviceDetail, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, serviceDetail: e.target.value })), children: getBookingServiceDetailOptions(publicBookingForm.serviceType).map((detail) => ((0, jsx_runtime_1.jsx)("option", { value: detail, children: detail }, detail))) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Concern / Requested Service" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: publicBookingForm.concern, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, concern: e.target.value })), placeholder: "Describe the service request" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: publicBookingForm.notes, onChange: (e) => setPublicBookingForm((prev) => ({ ...prev, notes: e.target.value })), placeholder: "Optional notes" })] }), publicBookingError ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: publicBookingError }) : null, (0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.primaryButton, disabled: isPublicBookingSubmitting, children: "Submit Public Booking" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoBox, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.demoTitle, children: "Public Booking Landing Page" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoGrid, children: [(0, jsx_runtime_1.jsx)("div", { children: "This tab works without customer login and can be used as a public-facing landing page." }), (0, jsx_runtime_1.jsx)("div", { children: "Each submission creates a booking record inside the Bookings module for staff follow-up." }), (0, jsx_runtime_1.jsx)("div", { children: "The calendar strip helps customers pick an upcoming date faster on mobile." })] })] })] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("form", { onSubmit: onSupplierSubmit, style: styles.loginForm, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Supplier Name" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: supplierForm.supplierName, onChange: (e) => setSupplierForm({ supplierName: e.target.value }), placeholder: "Enter supplier name" })] }), supplierError ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: supplierError }) : null, (0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.primaryButton, children: "Open Supplier Portal" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoBox, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.demoTitle, children: "Supplier Portal Note" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.demoGrid, children: [(0, jsx_runtime_1.jsx)("div", { children: "Open requests come from the same internal Parts module." }), (0, jsx_runtime_1.jsx)("div", { children: "Bids submitted here are added directly to the matching request record." }), (0, jsx_runtime_1.jsx)("div", { children: "Staff can still privately compare bids and choose the winning supplier internally." })] })] })] }))] }) }));
}
function CustomerPortalPage({ customer, repairOrders, setRepairOrders, approvalLinkTokens, intakeRecords, inspectionRecords, qcRecords, releaseRecords, approvalRecords, backjobRecords, invoiceRecords, paymentRecords, bookings, setBookings, customerAccounts, setCustomerAccounts, setCustomerSession, onLogout, isCompactLayout, isDemoMode, portalLaunchView, sharedLinkRoId, sharedLinkMode, }) {
    const [portalView, setPortalView] = (0, react_1.useState)(portalLaunchView ?? "dashboard");
    ...
    const linkedRepairOrders = (0, react_1.useMemo)(() => {
    ...
    const linkedVehicleKeys = (0, react_1.useMemo)(() => {
        const keys = new Set();
    ...
    const portalVehicleGroups = (0, react_1.useMemo)(() => {
    ...
    const portalInspectionRows = (0, react_1.useMemo)(() => {
    ...
    const approvalReviewRows = (0, react_1.useMemo)(() => portalInspectionRows.map(({ row, inspection }) => ({
        row,
        inspection,
    ...
    const displayedApprovalReviewRows = (0, react_1.useMemo)(() => {
        if (!sharedLinkRoId)
    ...
    const [bookingForm, setBookingForm] = (0, react_1.useState)(() => getDefaultBookingForm(customer.fullName));
    const [bookingError, setBookingError] = (0, react_1.useState)("");
    const [portalVehicleForm, setPortalVehicleForm] = (0, react_1.useState)({
        plateNumber: "",
        conductionNumber: "",
        make: "",
        model: "",
    ...
    const [portalVehicleError, setPortalVehicleError] = (0, react_1.useState)("");
    const [isSubmittingPortalBooking, setIsSubmittingPortalBooking] = (0, react_1.useState)(false);
    const [isSavingPortalVehicle, setIsSavingPortalVehicle] = (0, react_1.useState)(false);
    const customerBookings = (0, react_1.useMemo)(() => {
        return bookings
            .filter((row) => {
            const rowPhone = sanitizePhone(row.phone || "");
            const rowEmail = (row.email || "").trim().toLowerCase();
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: globalCss }), (0, jsx_runtime_1.jsx)("div", { style: styles.appShell, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.mainArea, children: [(0, jsx_runtime_1.jsxs)("header", { style: styles.topBar, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.topBarLeft, children: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.pageTitle, children: "Customer Portal" }), (0, jsx_runtime_1.jsx)("div", { style: styles.pageSubtitle, children: BUILD_VERSION })] }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.topBarRight, children: [isDemoMode ? (0, jsx_runtime_1.jsx)("span", { style: styles.statusWarning, children: "Demo Mode" }) : null, sharedLinkMode ? (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: "Customer View" }) : null, (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: ["Pending approvals: ", pendingApprovalCount, "  |  Active links: ", activePortalLinks] }), (0, jsx_runtime_1.jsx)("div", { style: styles.topBarName, children: customer.fullName }), (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: onLogout, style: styles.logoutButtonCompact, children: "Sign Out" })] })] }), (0, jsx_runtime_1.jsxs)("main", { style: styles.mainContent, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "dashboard" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("dashboard"), children: "Dashboard" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "jobs" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("jobs"), children: "Jobs" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "approvals" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("approvals"), children: "Approvals" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "inspection" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("inspection"), children: "Inspection Report" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "myVehicles" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("myVehicles"), children: "My Vehicles" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "bookings" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("bookings"), children: "Book Service" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.portalHeroCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.portalHeroTitle, children: ["Welcome back, ", customer.fullName] }), (0, jsx_runtime_1.jsx)("div", { style: styles.portalHeroText, children: "Review current repair orders, inspect approval items, and browse the full history of every linked vehicle from one customer portal." })] }), portalView === "dashboard" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: isCompactLayout ? "span 12" : "span 3" }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Active Jobs" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: activeJobCount }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Jobs still being worked on or awaiting next action" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: isCompactLayout ? "span 12" : "span 3" }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Pending Approvals" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: pendingApprovalCount }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Recommended items that still need your decision" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: isCompactLayout ? "span 12" : "span 3" }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Completed Jobs" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: releasedJobCount }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Finished jobs already handed over or closed" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: isCompactLayout ? "span 12" : "span 3" }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "My Vehicles" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: portalVehicleGroups.length }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Vehicles linked to this customer account" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Your Account", subtitle: "Cleaner customer-facing view of linked vehicles, open jobs, approvals, and portal access", children: (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessList, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Name" }), (0, jsx_runtime_1.jsx)("strong", { children: customer.fullName })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Phone" }), (0, jsx_runtime_1.jsx)("strong", { children: customer.phone || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Email" }), (0, jsx_runtime_1.jsx)("strong", { children: customer.email || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Vehicles" }), (0, jsx_runtime_1.jsx)("strong", { children: customerLinkedPlateNumbers.join(", ") || portalVehicleGroups.map((group) => group.plateNumber || group.conductionNumber).filter(Boolean).join(", ") || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Open Jobs" }), (0, jsx_runtime_1.jsx)("strong", { children: activeJobCount })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Pending Decisions" }), (0, jsx_runtime_1.jsx)("strong", { children: pendingApprovalCount })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "SMS Approval Links" }), (0, jsx_runtime_1.jsx)("strong", { children: activePortalLinks })] })] }) }) })] })) : portalView === "jobs" ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: linkedRepairOrders.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No repair orders linked to this portal account yet." })) : (linkedRepairOrders.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.roNumber }), (0, jsx_runtime_1.jsx)(ROStatusBadge, { status: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: [row.make, row.model, row.year].filter(Boolean).join(" ") || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: ["Advisor: ", row.advisorName || "-"] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Approval Snapshot" }), (0, jsx_runtime_1.jsxs)("strong", { children: [row.workLines.filter((line) => line.approvalDecision === "Approved").length, " approved  |  ", row.workLines.filter((line) => (line.approvalDecision ?? "Pending") === "Pending").length, " pending"] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Concern" }), (0, jsx_runtime_1.jsx)("strong", { children: row.customerConcern || "-" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.quickAccessList, children: row.workLines.map((line) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: line.customerDescription || line.title || "Work Item" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(parseMoneyInput(line.totalEstimate)) })] }, line.id))) })] }, row.id)))) })) : portalView === "inspection" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileCardList, children: [(0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginBottom: 8 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Condition Legend" }), (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", marginTop: 6 }, children: [(0, jsx_runtime_1.jsx)("span", { style: { background: "#dcfce7", color: "#15803d", borderRadius: 4, padding: "2px 10px", fontWeight: 600, fontSize: 12 }, children: "Good" }), (0, jsx_runtime_1.jsx)("span", { style: { background: "#fef3c7", color: "#b45309", borderRadius: 4, padding: "2px 10px", fontWeight: 600, fontSize: 12 }, children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("span", { style: { background: "#fee2e2", color: "#b91c1c", borderRadius: 4, padding: "2px 10px", fontWeight: 600, fontSize: 12 }, children: "Critical" })] })] }), portalInspectionRows.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No inspection records available." })) : (portalInspectionRows.map(({ row, inspection }) => {
                                            ...
                                            return ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.mobileDataCard, padding: 0, overflow: "hidden" }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { background: "#1e293b", padding: "12px 14px" }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }, children: [(0, jsx_runtime_1.jsx)("strong", { style: { color: "#f8fafc", fontSize: 15 }, children: inspection.inspectionNumber }), (0, jsx_runtime_1.jsx)("span", { style: getInspectionStatusStyle(inspection.status), children: inspection.status })] }), (0, jsx_runtime_1.jsxs)("div", { style: { color: "#94a3b8", fontSize: 13, marginTop: 2 }, children: [row.roNumber, "  |  ", inspection.accountLabel] }), (0, jsx_runtime_1.jsxs)("div", { style: { color: "#64748b", fontSize: 12 }, children: [inspection.plateNumber || inspection.conductionNumber || "-", "  |  ", [inspection.make, inspection.model, inspection.year].filter(Boolean).join(" ") || "-"] }), (0, jsx_runtime_1.jsxs)("div", { style: { color: "#94a3b8", fontSize: 12 }, children: ["Created ", formatDateTime(inspection.createdAt), "  |  Updated ", formatDateTime(inspection.updatedAt)] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { padding: "12px 14px" }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, marginBottom: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { background: "#dcfce7", borderRadius: 6, padding: "8px 10px", textAlign: "center" }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: 20, fontWeight: 700, color: "#15803d" }, children: totals.Good }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: 11, color: "#15803d" }, children: "Good" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { background: "#fef3c7", borderRadius: 6, padding: "8px 10px", textAlign: "center" }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: 20, fontWeight: 700, color: "#b45309" }, children: totals["Needs Attention"] }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: 11, color: "#b45309" }, children: "Needs Attention" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { background: "#fee2e2", borderRadius: 6, padding: "8px 10px", textAlign: "center" }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: 20, fontWeight: 700, color: "#b91c1c" }, children: totals.Critical }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: 11, color: "#b91c1c" }, children: "Critical" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { background: "#e2e8f0", borderRadius: 6, padding: "8px 10px", textAlign: "center" }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: 20, fontWeight: 700, color: "#334155" }, children: mediaCount }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: 11, color: "#334155" }, children: "Media" })] })] }), sections.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No inspection findings recorded." })) : (sections.map((section) => ((0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: 14 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { fontWeight: 600, fontSize: 13, color: "#334155", borderBottom: "1px solid #e2e8f0", paddingBottom: 4, marginBottom: 8 }, children: [section.label, " ", (0, jsx_runtime_1.jsxs)("span", { style: { fontWeight: 400, color: "#94a3b8", fontSize: 12 }, children: ["(", section.findings.length, ")"] })] }), section.note ? (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: section.note }) : null, (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: section.findings.map((finding, findingIndex) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8, flexWrap: "wrap" }, children: [(0, jsx_runtime_1.jsx)("strong", { style: { fontSize: 14 }, children: finding.title }), (0, jsx_runtime_1.jsx)("span", { style: getCustomerInspectionStatusStyle(finding.status), children: finding.status })] }), finding.note ? (0, jsx_runtime_1.jsx)("div", { style: { fontSize: 13, color: "#475569", marginTop: 4 }, children: finding.note }) : null] }, `${section.label}_${finding.title}_${findingIndex}`))) })] }, section.label)))), mediaGroups.length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { fontWeight: 600, fontSize: 13, color: "#334155", borderBottom: "1px solid #e2e8f0", paddingBottom: 4, marginBottom: 8 }, children: ["Photos / Videos (", mediaCount, ")"] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: mediaGroups.map(({ section, media }) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { style: { fontWeight: 600, fontSize: 13, color: "#334155", marginBottom: 6 }, children: [section, " (", media.length, ")"] }), (0, jsx_runtime_1.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(110px, 1fr))", gap: 8 }, children: media.map((item) => ((0, jsx_runtime_1.jsxs)("div", { style: { borderRadius: 6, overflow: "hidden", border: "1px solid #e2e8f0", background: "#fff" }, children: [item.previewDataUrl && item.type === "Photo" ? ((0, jsx_runtime_1.jsx)("img", { src: item.previewDataUrl, alt: item.itemLabel || item.section || "Inspection photo", style: { width: "100%", aspectRatio: "1", objectFit: "cover", display: "block" } })) : item.previewDataUrl && item.type === "Video" ? ((0, jsx_runtime_1.jsx)("video", { src: item.previewDataUrl, controls: true, style: { width: "100%", aspectRatio: "1", objectFit: "cover", display: "block", background: "#0f172a" } })) : ((0, jsx_runtime_1.jsxs)("div", { style: { minHeight: 92, padding: "10px 8px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 4, background: "#f8fafc" }, children: [(0, jsx_runtime_1.jsx)("strong", { style: { fontSize: 12, color: "#0f172a" }, children: item.type }), (0, jsx_runtime_1.jsx)("span", { style: { fontSize: 11, color: "#64748b" }, children: item.fileName })] })), (0, jsx_runtime_1.jsx)("div", { style: { padding: "4px 6px", fontSize: 10, color: "#64748b", background: "#f8fafc" }, children: item.itemLabel || item.section || item.fileName })] }, item.id))) })] }, section))) })] })) : null] })] }, inspection.id));
                                        }))] })) : portalView === "bookings" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(5, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "My Booking Requests", subtitle: "Track customer-submitted service requests and appointment status", children: customerBookings.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No booking requests yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: customerBookings.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.bookingNumber }), (0, jsx_runtime_1.jsx)("span", { style: getBookingStatusStyle(row.status), children: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [row.serviceType, "  |  ", row.serviceDetail || "-", "  |  ", row.requestedDate, " ", row.requestedTime] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: row.concern || row.notes || "Booking request" })] }, row.id))) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(7, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Request New Appointment", subtitle: "Choose one of your vehicles and send a booking request to the shop", children: (0, jsx_runtime_1.jsxs)("form", { onSubmit: submitPortalBooking, style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Vehicle" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: selectedVehicleKey, onChange: (e) => setSelectedVehicleKey(e.target.value), children: [portalVehicleGroups.map((group) => ((0, jsx_runtime_1.jsxs)("option", { value: group.vehicleKey, children: [group.plateNumber || group.conductionNumber || "No plate", "  |  ", group.vehicleLabel] }, group.vehicleKey))), (0, jsx_runtime_1.jsx)("option", { value: "__new__", children: "+ Add New Vehicle for This Booking" })] })] }), selectedVehicleKey === "__new__" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "New Vehicle Details" }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Plate Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: bookingForm.plateNumber, onChange: (e) => setBookingForm((prev) => ({ ...prev, plateNumber: e.target.value })), placeholder: "ABC-1234" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Conduction Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: bookingForm.conductionNumber, onChange: (e) => setBookingForm((prev) => ({ ...prev, conductionNumber: e.target.value })), placeholder: "Use if no plate yet" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Make" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: bookingForm.make, onChange: (e) => setBookingForm((prev) => ({ ...prev, make: e.target.value })), placeholder: "Toyota" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Model" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: bookingForm.model, onChange: (e) => setBookingForm((prev) => ({ ...prev, model: e.target.value })), placeholder: "Fortuner" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Year" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: bookingForm.year, onChange: (e) => setBookingForm((prev) => ({ ...prev, year: e.target.value })), placeholder: "2021" })] })] })] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Preferred Date" }), (0, jsx_runtime_1.jsx)("input", { type: "date", style: styles.input, value: bookingForm.requestedDate, onChange: (e) => setBookingForm((prev) => ({ ...prev, requestedDate: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Preferred Time" }), (0, jsx_runtime_1.jsx)("input", { type: "time", style: styles.input, value: bookingForm.requestedTime, onChange: (e) => setBookingForm((prev) => ({ ...prev, requestedTime: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Service Type" }), (0, jsx_runtime_1.jsx)("select", { style: styles.select, value: bookingForm.serviceType, onChange: (e) => setBookingForm((prev) => {
                                                                                const nextType = e.target.value;
                                                                                return {
                                                                                    ...prev,
                                                                                    serviceType: nextType,
                                                                            ...
                                                                            }), children: BOOKING_SERVICE_OPTIONS.map((type) => ((0, jsx_runtime_1.jsx)("option", { value: type, children: type }, type))) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Service Detail" }), (0, jsx_runtime_1.jsx)("select", { style: styles.select, value: bookingForm.serviceDetail, onChange: (e) => setBookingForm((prev) => ({ ...prev, serviceDetail: e.target.value })), children: getBookingServiceDetailOptions(bookingForm.serviceType).map((detail) => ((0, jsx_runtime_1.jsx)("option", { value: detail, children: detail }, detail))) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Concern / Request" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: bookingForm.concern, onChange: (e) => setBookingForm((prev) => ({ ...prev, concern: e.target.value })), placeholder: "Describe the service request" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: bookingForm.notes, onChange: (e) => setBookingForm((prev) => ({ ...prev, notes: e.target.value })), placeholder: "Optional notes" })] }), bookingError ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: bookingError }) : null, (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.primaryButton, disabled: isSubmittingPortalBooking, children: "Submit Booking Request" }) })] }) }) })] })) : portalView === "approvals" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileCardList, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Customer Approval Review" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Review the inspection findings by category, then approve, defer, or decline the linked recommendations for each repair order." }), (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)("span", { style: { background: "#dcfce7", color: "#15803d", borderRadius: 4, padding: "2px 10px", fontWeight: 600, fontSize: 12 }, children: "Good" }), (0, jsx_runtime_1.jsx)("span", { style: { background: "#fef3c7", color: "#b45309", borderRadius: 4, padding: "2px 10px", fontWeight: 600, fontSize: 12 }, children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("span", { style: { background: "#fee2e2", color: "#b91c1c", borderRadius: 4, padding: "2px 10px", fontWeight: 600, fontSize: 12 }, children: "Critical" })] })] }), sharedLinkRoId ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginBottom: 8 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Shared Approval Link" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "This is a simulated customer-facing approval link opened from the staff app for internal demo testing." }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessList, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Mode" }), (0, jsx_runtime_1.jsx)("strong", { children: "Customer-facing demo link" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Focus RO" }), (0, jsx_runtime_1.jsx)("strong", { children: sharedLinkRoId })] })] })] })) : null, displayedApprovalReviewRows.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No inspection-linked recommendations available for approval review." })) : (displayedApprovalReviewRows.map(({ row, inspection, sections, mediaGroups }) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.roNumber }), (0, jsx_runtime_1.jsx)(ROStatusBadge, { status: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.accountLabel }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: [row.make, row.model, row.year].filter(Boolean).join(" ") || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Inspection" }), (0, jsx_runtime_1.jsx)("strong", { children: inspection.inspectionNumber })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Pending decisions" }), (0, jsx_runtime_1.jsx)("strong", { children: row.workLines.filter((line) => (line.approvalDecision ?? "Pending") === "Pending").length })] }), (0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Inspection Findings" }), sections.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No inspection findings recorded." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: sections.map((section) => {
                                                                const sectionMedia = mediaGroups.find((group) => group.section === section.label)?.media ?? [];
                                                                return ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: section.label }), (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [section.findings.length, " items"] })] }), section.note ? (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: section.note }) : null, (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: section.findings.map((finding, findingIndex) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8, flexWrap: "wrap" }, children: [(0, jsx_runtime_1.jsx)("strong", { style: { fontSize: 14 }, children: finding.title }), (0, jsx_runtime_1.jsx)("span", { style: getCustomerInspectionStatusStyle(finding.status), children: finding.status })] }), finding.note ? (0, jsx_runtime_1.jsx)("div", { style: { fontSize: 13, color: "#475569", marginTop: 4 }, children: finding.note }) : null] }, `${section.label}_${finding.title}_${findingIndex}`))) }), sectionMedia.length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { fontWeight: 600, fontSize: 13, color: "#334155", marginBottom: 8 }, children: ["Media (", sectionMedia.length, ")"] }), (0, jsx_runtime_1.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(110px, 1fr))", gap: 8 }, children: sectionMedia.map((item) => ((0, jsx_runtime_1.jsxs)("div", { style: { borderRadius: 6, overflow: "hidden", border: "1px solid #e2e8f0", background: "#fff" }, children: [item.previewDataUrl && item.type === "Photo" ? ((0, jsx_runtime_1.jsx)("img", { src: item.previewDataUrl, alt: item.itemLabel || item.section || "Inspection photo", style: { width: "100%", aspectRatio: "1", objectFit: "cover", display: "block" } })) : item.previewDataUrl && item.type === "Video" ? ((0, jsx_runtime_1.jsx)("video", { src: item.previewDataUrl, controls: true, style: { width: "100%", aspectRatio: "1", objectFit: "cover", display: "block", background: "#0f172a" } })) : ((0, jsx_runtime_1.jsxs)("div", { style: { minHeight: 92, padding: "10px 8px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 4, background: "#f8fafc" }, children: [(0, jsx_runtime_1.jsx)("strong", { style: { fontSize: 12, color: "#0f172a" }, children: item.type }), (0, jsx_runtime_1.jsx)("span", { style: { fontSize: 11, color: "#64748b" }, children: item.fileName })] })), (0, jsx_runtime_1.jsx)("div", { style: { padding: "4px 6px", fontSize: 10, color: "#64748b", background: "#f8fafc" }, children: item.itemLabel || item.section || item.fileName })] }, item.id))) })] })) : null] }, section.label));
                                                            }) }))] }), (0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Recommendations" }), row.workLines.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No recommendations linked to this repair order." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: row.workLines.map((line) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.customerDescription || line.title || "Work Item" }), (0, jsx_runtime_1.jsx)("span", { style: getApprovalDecisionStyle(line.approvalDecision ?? "Pending"), children: line.approvalDecision ?? "Pending" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category || "General", "  |  ", line.priority, " priority"] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: line.notes || getCustomerFriendlyLineDescription(line) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Total" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(parseMoneyInput(line.totalEstimate)) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => setCustomerDecision(row.id, line.id, "Approved"), children: "Approve" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => setCustomerDecision(row.id, line.id, "Deferred"), children: "Defer" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => setCustomerDecision(row.id, line.id, "Declined"), children: "Decline" })] })] }, line.id))) }))] })] }, row.id))))] })) : portalView === "myVehicles" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(4, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)(Card, { title: "My Vehicles", subtitle: "Each vehicle is grouped separately with latest visit first", children: [(0, jsx_runtime_1.jsxs)("form", { onSubmit: handleAddPortalVehicle, style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Add Vehicle" }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Plate Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: portalVehicleForm.plateNumber, onChange: (e) => setPortalVehicleForm((prev) => ({ ...prev, plateNumber: e.target.value })), placeholder: "ABC-1234" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Conduction Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: portalVehicleForm.conductionNumber, onChange: (e) => setPortalVehicleForm((prev) => ({ ...prev, conductionNumber: e.target.value })), placeholder: "Optional if no plate yet" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Make" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: portalVehicleForm.make, onChange: (e) => setPortalVehicleForm((prev) => ({ ...prev, make: e.target.value })), placeholder: "Toyota" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Model" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: portalVehicleForm.model, onChange: (e) => setPortalVehicleForm((prev) => ({ ...prev, model: e.target.value })), placeholder: "Fortuner" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Year" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: portalVehicleForm.year, onChange: (e) => setPortalVehicleForm((prev) => ({ ...prev, year: e.target.value })), placeholder: "2021" })] })] }), portalVehicleError ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: portalVehicleError }) : null, (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.smallButton, disabled: isSavingPortalVehicle, children: "Add Vehicle" }) })] }), portalVehicleGroups.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No vehicles are linked to this customer portal yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: portalVehicleGroups.map((group) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: () => setSelectedVehicleKey(group.vehicleKey), style: {
                                                                ...styles.mobileDataCard,
                                                                ...(selectedVehicleKey === group.vehicleKey ? styles.selectedQueueCard : {}),
                                                                textAlign: "left",
                                                                cursor: "pointer",
                                                            }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: group.plateNumber || group.conductionNumber || group.vehicleKey }), group.activeJobCount > 0 ? (0, jsx_runtime_1.jsxs)("span", { style: styles.statusWarning, children: [group.activeJobCount, " Active"] }) : (0, jsx_runtime_1.jsx)("span", { style: styles.statusOk, children: "No Open Job" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: group.vehicleLabel }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: ["Latest Odometer: ", group.latestOdometerKm || "-"] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: ["Last Visit: ", formatDateTime(group.lastVisitAt)] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Total Visits" }), (0, jsx_runtime_1.jsx)("strong", { children: group.totalVisits })] })] }, group.vehicleKey))) }))] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(8, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: selectedVehicleGroup ? `Vehicle Timeline  -  ${selectedVehicleGroup.plateNumber || selectedVehicleGroup.conductionNumber || selectedVehicleGroup.vehicleKey}` : "Vehicle Timeline", subtitle: "Newest transaction first with odometer and status shown", right: selectedVehicleGroup ? (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: selectedVehicleGroup.vehicleLabel }) : undefined, children: !selectedVehicleGroup ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "Select a vehicle to review its history." })) : ((0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionCardMuted, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessList, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Plate Number" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedVehicleGroup.plateNumber || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Conduction Number" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedVehicleGroup.conductionNumber || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Vehicle" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedVehicleGroup.vehicleLabel })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Latest Odometer" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedVehicleGroup.latestOdometerKm || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Last Visit" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(selectedVehicleGroup.lastVisitAt) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Total Visits" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedVehicleGroup.totalVisits })] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: selectedVehicleGroup.rows.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.type }), (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: row.status || "-" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.number }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: formatDateTime(row.date) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Odometer" }), (0, jsx_runtime_1.jsx)("strong", { children: row.odometerKm || "-" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: row.summary || "-" })] }, row.id))) })] })) }) })] })) : null] })] }) })] }));
}
function SupplierPortalPage({ supplier, partsRequests, setPartsRequests, onLogout, isCompactLayout, }) {
    const [portalView, setPortalView] = (0, react_1.useState)("openRequests");
    const [search, setSearch] = (0, react_1.useState)("");
    const [selectedRequestId, setSelectedRequestId] = (0, react_1.useState)("");
    const [brand, setBrand] = (0, react_1.useState)("");
    const [quantity, setQuantity] = (0, react_1.useState)("1");
    const [unitCost, setUnitCost] = (0, react_1.useState)("");
    const [deliveryTime, setDeliveryTime] = (0, react_1.useState)("");
    const [warrantyNote, setWarrantyNote] = (0, react_1.useState)("");
    const [condition, setCondition] = (0, react_1.useState)("Brand New");
    const [notes, setNotes] = (0, react_1.useState)("");
    const [trackingNumber, setTrackingNumber] = (0, react_1.useState)("");
    const [courierName, setCourierName] = (0, react_1.useState)("");
    const [shippingNotes, setShippingNotes] = (0, react_1.useState)("");
    const [invoiceFileName, setInvoiceFileName] = (0, react_1.useState)("");
    const [shippingLabelFileName, setShippingLabelFileName] = (0, react_1.useState)("");
    const [error, setError] = (0, react_1.useState)("");
    const [isSubmittingBid, setIsSubmittingBid] = (0, react_1.useState)(false);
    const [returnResponseStatus, setReturnResponseStatus] = (0, react_1.useState)("Approved");
    const [returnResponseNotes, setReturnResponseNotes] = (0, react_1.useState)("");
    const openRequests = (0, react_1.useMemo)(() => {
    ...
    const myBids = (0, react_1.useMemo)(() => partsRequests.flatMap((request) => request.bids
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: globalCss }), (0, jsx_runtime_1.jsx)("div", { style: styles.appShell, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.mainArea, children: [(0, jsx_runtime_1.jsxs)("header", { style: styles.topBar, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.topBarLeft, children: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.pageTitle, children: "Supplier Portal" }), (0, jsx_runtime_1.jsx)("div", { style: styles.pageSubtitle, children: BUILD_VERSION })] }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.topBarRight, children: [(0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: ["Open requests: ", openRequests.length, "  |  My bids: ", myBids.length] }), (0, jsx_runtime_1.jsx)("div", { style: styles.topBarName, children: supplier.supplierName }), (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: onLogout, style: styles.logoutButtonCompact, children: "Sign Out" })] })] }), (0, jsx_runtime_1.jsxs)("main", { style: styles.mainContent, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "openRequests" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("openRequests"), children: "Open Requests" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, ...(portalView === "myBids" ? styles.portalTabActive : {}) }, onClick: () => setPortalView("myBids"), children: "My Submitted Bids" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.portalHeroCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.portalHeroTitle, children: "Media, shipping, and return response center" }), (0, jsx_runtime_1.jsx)("div", { style: styles.portalHeroText, children: "Review workshop reference pictures, submit bid photos, upload invoice and shipping label details, and respond to return requests with reasons and pictures." })] }), portalView === "openRequests" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(5, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)(Card, { title: "Open Parts Requests", subtitle: "Requests ready for supplier review and quotation", children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Search Requests" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search request no., RO, plate, part, vehicle" })] }), openRequests.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No open requests available right now." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: openRequests.map((request) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: () => setSelectedRequestId(request.id), style: {
                                                                ...styles.mobileDataCard,
                                                                ...(selectedRequestId === request.id ? styles.selectedQueueCard : {}),
                                                                textAlign: "left",
                                                                cursor: "pointer",
                                                            }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: request.requestNumber }), (0, jsx_runtime_1.jsx)("span", { style: getPartsRequestStatusStyle(request.status), children: request.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: request.partName }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: request.partNumber || "No part number" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [request.vehicleLabel, "  |  ", request.plateNumber || "-"] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Workshop Photos" }), (0, jsx_runtime_1.jsx)("strong", { children: request.workshopPhotos.length })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Bids" }), (0, jsx_runtime_1.jsx)("strong", { children: request.bids.length })] })] }, request.id))) }))] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(7, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Submit Supplier Bid", subtitle: "Use workshop media as reference, then send pricing, pictures, and shipping-ready details", children: !selectedRequest ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "Select a request from the left to submit a bid." })) : ((0, jsx_runtime_1.jsxs)("form", { onSubmit: submitBid, style: styles.formStack, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionCardMuted, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessList, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Request" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedRequest.requestNumber })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "RO" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedRequest.roNumber })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Part" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedRequest.partName })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Required Qty" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedRequest.quantity })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Vehicle" }), (0, jsx_runtime_1.jsx)("strong", { children: selectedRequest.vehicleLabel })] })] }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Workshop Reference Pictures" }), selectedRequest.workshopPhotos.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No workshop pictures uploaded yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.partsMediaGrid, children: selectedRequest.workshopPhotos.map((photo) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.partsMediaCard, children: [(0, jsx_runtime_1.jsx)("img", { src: photo.previewDataUrl, alt: photo.fileName, style: styles.partsMediaImage }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: photo.fileName })] }, photo.id))) }))] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Supplier" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: supplier.supplierName, disabled: true })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Brand" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: brand, onChange: (e) => setBrand(e.target.value), placeholder: "Brand or line" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Quantity" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: quantity, onChange: (e) => setQuantity(e.target.value) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Unit Cost" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: unitCost, onChange: (e) => setUnitCost(e.target.value), placeholder: "PHP" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Condition" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: condition, onChange: (e) => setCondition(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "Brand New", children: "Brand New" }), (0, jsx_runtime_1.jsx)("option", { value: "OEM", children: "OEM" }), (0, jsx_runtime_1.jsx)("option", { value: "Replacement", children: "Replacement" }), (0, jsx_runtime_1.jsx)("option", { value: "Surplus", children: "Surplus" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Delivery Time" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: deliveryTime, onChange: (e) => setDeliveryTime(e.target.value), placeholder: "Same day / 2 days / 1 week" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Warranty Note" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: warrantyNote, onChange: (e) => setWarrantyNote(e.target.value), placeholder: "Optional warranty note" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Add Product Photos" }), (0, jsx_runtime_1.jsx)("input", { id: "supplier-product-photos", style: styles.input, type: "file", accept: "image/*", multiple: true }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "You can select multiple photos in one upload and add more in future updates." }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Add one or many product photos now, then add more later if needed." })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Invoice File Name" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: invoiceFileName, onChange: (e) => setInvoiceFileName(e.target.value), placeholder: "Invoice file or number" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Shipping Label File Name" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: shippingLabelFileName, onChange: (e) => setShippingLabelFileName(e.target.value), placeholder: "Label file name" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Tracking Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: trackingNumber, onChange: (e) => setTrackingNumber(e.target.value), placeholder: "Tracking number" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Courier" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: courierName, onChange: (e) => setCourierName(e.target.value), placeholder: "Courier / shipper" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Shipping Notes" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: shippingNotes, onChange: (e) => setShippingNotes(e.target.value), placeholder: "Optional shipping note" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: notes, onChange: (e) => setNotes(e.target.value), placeholder: "Optional fitment, stock, or delivery notes" })] }), error ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: error }) : null, (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.primaryButton, disabled: isSubmittingBid, children: "Submit Bid" }) })] })) }) })] })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: myBids.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No bids submitted from this supplier portal session yet." })) : (myBids.map(({ request, bid }) => {
                                        const latestReturn = request.returnRecords[0] ?? null;
                                        return ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: request.requestNumber }), (0, jsx_runtime_1.jsx)("span", { style: getPartsRequestStatusStyle(request.status), children: request.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: request.partName }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [bid.brand || "No brand", "  |  ", bid.condition] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Total Bid" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(parseMoneyInput(bid.totalCost)) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Delivery" }), (0, jsx_runtime_1.jsx)("strong", { children: bid.deliveryTime || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Tracking" }), (0, jsx_runtime_1.jsx)("strong", { children: bid.trackingNumber || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Invoice" }), (0, jsx_runtime_1.jsx)("strong", { children: bid.invoiceFileName || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Label" }), (0, jsx_runtime_1.jsx)("strong", { children: bid.shippingLabelFileName || "-" })] }), bid.productPhotos.length > 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.partsMediaGrid, children: bid.productPhotos.map((photo) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.partsMediaCard, children: [(0, jsx_runtime_1.jsx)("img", { src: photo.previewDataUrl, alt: photo.fileName, style: styles.partsMediaImage }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: photo.fileName })] }, photo.id))) })) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Update Shipping" }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Invoice File Name" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: invoiceFileName, onChange: (e) => setInvoiceFileName(e.target.value), placeholder: bid.invoiceFileName || "Invoice file or number" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Shipping Label File Name" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: shippingLabelFileName, onChange: (e) => setShippingLabelFileName(e.target.value), placeholder: bid.shippingLabelFileName || "Shipping label file" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Tracking Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: trackingNumber, onChange: (e) => setTrackingNumber(e.target.value), placeholder: bid.trackingNumber || "Tracking number" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Courier" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: courierName, onChange: (e) => setCourierName(e.target.value), placeholder: bid.courierName || "Courier" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Shipping Notes" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: shippingNotes, onChange: (e) => setShippingNotes(e.target.value), placeholder: bid.shippingNotes || "Optional note" })] })] }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => updateShippingForBid(request.id, bid.id), children: "Save Shipping Update" })] }), latestReturn ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Return Notification" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Reason: ", latestReturn.reason || "-"] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Notes: ", latestReturn.notes || "-"] }), latestReturn.pictures.length > 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.partsMediaGrid, children: latestReturn.pictures.map((photo) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.partsMediaCard, children: [(0, jsx_runtime_1.jsx)("img", { src: photo.previewDataUrl, alt: photo.fileName, style: styles.partsMediaImage }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: photo.fileName })] }, photo.id))) })) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Return Response" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: returnResponseStatus, onChange: (e) => setReturnResponseStatus(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "Approved", children: "Approved" }), (0, jsx_runtime_1.jsx)("option", { value: "Rejected", children: "Rejected" }), (0, jsx_runtime_1.jsx)("option", { value: "Replacement in Process", children: "Replacement in Process" }), (0, jsx_runtime_1.jsx)("option", { value: "Refund in Process", children: "Refund in Process" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Response Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: returnResponseNotes, onChange: (e) => setReturnResponseNotes(e.target.value), placeholder: "Explain the return response" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Add Response Photos" }), (0, jsx_runtime_1.jsx)("input", { id: `supplier-return-response-${request.id}`, style: styles.input, type: "file", accept: "image/*", multiple: true }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Add one or many response photos. New uploads are appended." })] }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => respondToReturn(request.id), children: "Send Return Response" })] })) : null] }, bid.id));
                                    })) }))] })] }) })] }));
}
function DashboardPage({ currentUser, users, roleDefinitions, allowedNav, intakeRecords, repairOrders, qcRecords, releaseRecords, approvalRecords, backjobRecords, invoiceRecords, paymentRecords, workLogs, partsRequests, isCompactLayout, }) {
    ...
    const reportTechProductivity = (0, helpers_1.getTechnicianProductivity)(repairOrders, workLogs, users);
    const reportAdvisorSales = (0, helpers_1.getAdvisorSalesProduced)(repairOrders, invoiceRecords);
    const reportRepeatCustomers = (0, helpers_1.getRepeatCustomerFrequency)(repairOrders);
    const reportQcSummary = (0, helpers_1.getQcPassFailSummary)(qcRecords);
    const reportWaitingPartsAging = (0, helpers_1.getWaitingPartsAging)(repairOrders, partsRequests);
    const reportBackjobRate = (0, helpers_1.getBackjobRate)(repairOrders, backjobRecords);
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: `Welcome, ${currentUser.fullName}`, subtitle: "Owner dashboard with workflow, financial, and technician reporting", right: (0, jsx_runtime_1.jsx)(RoleBadge, { role: currentUser.role }), children: (0, jsx_runtime_1.jsx)("div", { style: styles.heroText, children: "The app now includes live workflow reporting, payment and invoice metrics, technician performance, bottleneck visibility, and QC / comeback signals tied to your real repair-order pipeline." }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Active Users" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: activeUsers.length }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Loaded from localStorage" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Total Intakes" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: intakeRecords.length }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Phase 2 intake records" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Waiting Inspection" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: waitingInspection }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Ready for the next step" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Company / Fleet" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: fleetCount }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Shared company and fleet account count" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Daily Sales" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: formatCurrency(dailySales) }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Released jobs for today" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Monthly Projection" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: formatCurrency(monthlyProjection) }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Based on current month releases" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Approval Rate" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statValue, children: [approvalRate, "%"] }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Approved recommendation items" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Receivables" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: formatCurrency(receivables) }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Open invoice balance" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Payments Today" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: formatCurrency(paymentsToday) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statNote, children: [unpaidInvoices, " unpaid  |  ", partialInvoices, " partial"] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Open ROs" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: openROs }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statNote, children: [inProgressCount, " in progress  |  ", qcQueueCount, " in QC"] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Ready Release" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: readyReleaseCount }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statNote, children: [releasedCount, " already released"] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Payments This Month" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: formatCurrency(paymentsThisMonth) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statNote, children: ["Average release ", formatCurrency(avgReleaseValue)] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Fleet Mix" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statValue, children: [fleetShare, "%"] }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Company / fleet share of intake volume" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Estimated Gross Profit" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValueSmall, children: formatCurrency(estimatedGrossProfit) }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Labor + parts revenue minus internal parts cost" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Gross Margin" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statValue, children: [estimatedGrossMargin, "%"] }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Estimated margin across all repair orders" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Average Released Ticket" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValueSmall, children: formatCurrency(averageReleasedTicket) }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Average final released amount per job" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "QC Pass Rate" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statValue, children: [reportQcSummary.passRatePct, "%"] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statNote, children: [reportQcSummary.passed, " passed  |  ", reportQcSummary.failed, " failed of ", reportQcSummary.total] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Backjob Rate" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statValue, children: [reportBackjobRate.backjobRatePct, "%"] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statNote, children: [reportBackjobRate.backjobCount, " backjobs of ", reportBackjobRate.totalROs, " ROs"] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Repeat Customers" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: reportRepeatCustomers.length }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Vehicles / accounts with 2+ visits" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Parts-Blocked ROs" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: reportWaitingPartsAging.length }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: reportWaitingPartsAging[0] ? `Longest: ${reportWaitingPartsAging[0].daysWaiting}d` : "No blocked ROs" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(7, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "User Distribution", subtitle: "Active users by position", children: (0, jsx_runtime_1.jsx)("div", { style: styles.roleGrid, children: userRoleCounts.map((item) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.roleTile, children: [(0, jsx_runtime_1.jsx)(RoleBadge, { role: item.role }), (0, jsx_runtime_1.jsx)("strong", { style: styles.roleTileCount, children: item.count })] }, item.role))) }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(5, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Current Access", subtitle: "Pages available to your role", children: (0, jsx_runtime_1.jsx)("div", { style: styles.quickAccessList, children: allowedNav.map((item) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { style: styles.quickAccessIcon, children: item.icon }), (0, jsx_runtime_1.jsx)("span", { children: item.label })] }, item.key))) }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(6, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Workflow Bottlenecks", subtitle: "ROs waiting on next action", children: (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessList, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Waiting Approval" }), (0, jsx_runtime_1.jsx)("strong", { children: bottleneckWaitingApproval })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("strong", { children: bottleneckWaitingParts })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "QC Failures" }), (0, jsx_runtime_1.jsx)("strong", { children: qcFailures })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Backjobs Logged" }), (0, jsx_runtime_1.jsx)("strong", { children: backjobRecords.length })] })] }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(6, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Technician Productivity", subtitle: "Primary technician labor value, completed jobs, active workload, and QC fails", children: (0, jsx_runtime_1.jsx)("div", { style: styles.quickAccessList, children: techRevenueMap.map(({ user, total, completed, active, qcFailed, bookedMinutes, activeTimers, laborProduced, efficiency }) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: user.fullName }), (0, jsx_runtime_1.jsxs)("strong", { children: [formatCurrency(laborProduced || total), "  |  ", formatMinutesAsHours(bookedMinutes), "  |  ", completed, " done  |  ", active, " active  |  ", activeTimers, " live  |  ", qcFailed, " QC fail  |  ", efficiency, "% eff."] })] }, user.id))) }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(6, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Top Repair Orders by Profit", subtitle: "Estimated gross profit based on labor + parts revenue less internal parts cost", children: (0, jsx_runtime_1.jsx)("div", { style: styles.quickAccessList, children: roProfitMap.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No repair orders available yet." })) : (roProfitMap.map(({ ro, grossProfit, margin, laborRevenue, partsRevenue, partsCost }) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsxs)("span", { children: [ro.roNumber, "  |  ", ro.plateNumber || ro.conductionNumber || "-"] }), (0, jsx_runtime_1.jsxs)("strong", { children: [formatCurrency(grossProfit), "  |  ", margin, "% margin  |  L ", formatCurrency(laborRevenue), "  |  P ", formatCurrency(partsRevenue), "  |  Cost ", formatCurrency(partsCost)] })] }, ro.id)))) }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Recent Intake Activity", subtitle: "Newest encoded vehicles first", children: latestIntakes.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No intake records yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: latestIntakes.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.intakeNumber }), (0, jsx_runtime_1.jsx)(StatusBadge, { status: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.companyName || row.customerName || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: [row.make, row.model, row.year].filter(Boolean).join(" ") || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Encoded" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(row.createdAt) })] })] }, row.id))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Intake No." }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Plate" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Customer / Company" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Vehicle" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Status" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Encoded" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: latestIntakes.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.intakeNumber }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.companyName || row.customerName || "-" }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: `${row.make} ${row.model} ${row.year}`.trim() || "-" }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: (0, jsx_runtime_1.jsx)(StatusBadge, { status: row.status }) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatDateTime(row.createdAt) })] }, row.id))) })] }) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Your Effective Permissions", subtitle: "Action restrictions use these permissions", children: (0, jsx_runtime_1.jsx)("div", { style: styles.permissionWrap, children: ALL_PERMISSIONS.map((perm) => ((0, jsx_runtime_1.jsx)(PermissionPill, { permission: perm, checked: hasPermission(currentUser.role, roleDefinitions, perm), disabled: true }, perm))) }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Technician Productivity", subtitle: "Labor produced and logged hours per technician", children: reportTechProductivity.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No technician data yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: reportTechProductivity.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataCardHeader, children: (0, jsx_runtime_1.jsx)("strong", { children: row.technicianName }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Jobs" }), (0, jsx_runtime_1.jsx)("strong", { children: row.jobCount })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Labor Produced" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(row.laborProduced) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Logged" }), (0, jsx_runtime_1.jsx)("strong", { children: formatMinutesAsHours(row.loggedMinutes) })] })] }, row.technicianId))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Technician" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Jobs" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Labor Produced" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Logged" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: reportTechProductivity.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.technicianName }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.jobCount }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatCurrency(row.laborProduced) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatMinutesAsHours(row.loggedMinutes) })] }, row.technicianId))) })] }) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(6, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Advisor Sales Produced", subtitle: "RO volume and invoiced amounts per service advisor", children: reportAdvisorSales.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No invoice data yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: reportAdvisorSales.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataCardHeader, children: (0, jsx_runtime_1.jsx)("strong", { children: row.advisorName }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "ROs" }), (0, jsx_runtime_1.jsx)("strong", { children: row.roCount })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Total Invoiced" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(row.totalInvoiced) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Labor" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(row.laborSubtotal) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Parts" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(row.partsSubtotal) })] })] }, row.advisorName))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Advisor" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "ROs" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Total Invoiced" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Labor" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Parts" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: reportAdvisorSales.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.advisorName }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.roCount }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatCurrency(row.totalInvoiced) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatCurrency(row.laborSubtotal) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatCurrency(row.partsSubtotal) })] }, row.advisorName))) })] }) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(6, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "QC Pass / Fail by Officer", subtitle: "Quality check outcomes per QC officer", children: reportQcSummary.byQCOfficer.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No QC records yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: reportQcSummary.byQCOfficer.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataCardHeader, children: (0, jsx_runtime_1.jsx)("strong", { children: row.qcBy }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Total" }), (0, jsx_runtime_1.jsx)("strong", { children: row.total })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Passed" }), (0, jsx_runtime_1.jsx)("strong", { style: { color: "#15803d" }, children: row.passed })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Failed" }), (0, jsx_runtime_1.jsx)("strong", { style: { color: "#b91c1c" }, children: row.failed })] })] }, row.qcBy))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "QC Officer" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Total" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Passed" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Failed" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: reportQcSummary.byQCOfficer.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.qcBy }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.total }), (0, jsx_runtime_1.jsx)("td", { style: { ...styles.td, color: "#15803d" }, children: row.passed }), (0, jsx_runtime_1.jsx)("td", { style: { ...styles.td, color: row.failed > 0 ? "#b91c1c" : undefined }, children: row.failed })] }, row.qcBy))) })] }) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(8, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Waiting Parts Aging", subtitle: "ROs blocked by parts requests, sorted by days waiting", children: reportWaitingPartsAging.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No parts-blocked ROs." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: reportWaitingPartsAging.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.roNumber }), (0, jsx_runtime_1.jsxs)("span", { style: { color: row.daysWaiting >= 3 ? "#b45309" : undefined }, children: [row.daysWaiting, "d waiting"] })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.accountLabel || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.blockedWorkLineTitles.join(", ") || "-" })] }, row.roId))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "RO No." }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Plate" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Account" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Days Waiting" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Blocked Work Lines" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: reportWaitingPartsAging.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.roNumber }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.plateNumber || "-" }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.accountLabel || "-" }), (0, jsx_runtime_1.jsxs)("td", { style: { ...styles.td, color: row.daysWaiting >= 3 ? "#b45309" : undefined, fontWeight: row.daysWaiting >= 3 ? 700 : undefined }, children: [row.daysWaiting, "d"] }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.blockedWorkLineTitles.join(", ") || "-" })] }, row.roId))) })] }) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(4, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Backjob Breakdown", subtitle: "Comeback rate by responsibility", children: reportBackjobRate.byResponsibility.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No backjob records yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: reportBackjobRate.byResponsibility.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataCardHeader, children: (0, jsx_runtime_1.jsx)("strong", { children: row.responsibility }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Count" }), (0, jsx_runtime_1.jsx)("strong", { children: row.count })] })] }, row.responsibility))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Responsibility" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Count" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: reportBackjobRate.byResponsibility.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.responsibility }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.count })] }, row.responsibility))) })] }) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Repeat Customers / Vehicles", subtitle: "Vehicles or accounts with more than one repair order", children: reportRepeatCustomers.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No repeat visits recorded yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: reportRepeatCustomers.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataCardHeader, children: (0, jsx_runtime_1.jsx)("strong", { children: row.plateNumber || row.accountLabel || row.key }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Visits" }), (0, jsx_runtime_1.jsx)("strong", { children: row.visitCount })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Last Visit" }), (0, jsx_runtime_1.jsx)("strong", { children: row.lastVisitDate ? new Date(row.lastVisitDate).toLocaleDateString() : "-" })] })] }, row.key))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Plate / Account" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Visits" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Last Visit" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: reportRepeatCustomers.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.plateNumber || row.accountLabel || row.key }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.visitCount }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.lastVisitDate ? new Date(row.lastVisitDate).toLocaleDateString() : "-" })] }, row.key))) })] }) })) }) })] }) }));
}
function InspectionPage({ currentUser, intakeRecords, inspectionRecords, setInspectionRecords, setIntakeRecords, isCompactLayout, }) {
    ...
    const [selectedIntakeId, setSelectedIntakeId] = (0, react_1.useState)(inspectionDraftValue?.selectedIntakeId ?? "");
    const [form, setForm] = (0, react_1.useState)(() => inspectionDraftValue?.form ? { ...getDefaultInspectionForm(), ...inspectionDraftValue.form } : getDefaultInspectionForm());
    const [error, setError] = (0, react_1.useState)("");
    const [showDraftRestore, setShowDraftRestore] = (0, react_1.useState)(() => !!inspectionDraftValue);
    ...
    const [search, setSearch] = (0, react_1.useState)("");
    const [evidenceSection, setEvidenceSection] = (0, react_1.useState)("Under the Hood");
    const [evidenceItemLabel, setEvidenceItemLabel] = (0, react_1.useState)("");
    ...
    const eligibleIntakes = (0, react_1.useMemo)(() => intakeRecords.filter((row) => row.status === "Waiting Inspection" || row.status === "Draft"), [intakeRecords]);
    const selectedIntake = (0, react_1.useMemo)(() => intakeRecords.find((row) => row.id === selectedIntakeId) ?? null, [intakeRecords, selectedIntakeId]);
    const selectedInspection = (0, react_1.useMemo)(() => (selectedIntake ? inspectionRecords.find((row) => row.intakeId === selectedIntake.id) ?? null : null), [inspectionRecords, selectedIntake]);
    (0, react_1.useEffect)(() => {
    ...
    const filteredInspectionRecords = (0, react_1.useMemo)(() => {
        const term = search.trim().toLowerCase();
        if (!term)
    ...
    const inspectionHistoryMatches = (0, react_1.useMemo)(() => {
        const term = search.trim().toLowerCase();
        if (!term)
            return [];
        return inspectionRecords
    ...
    const relatedInspectionHistory = (0, react_1.useMemo)(() => {
        if (!selectedIntake)
            return [];
    ...
    const autoRecommendations = (0, react_1.useMemo)(() => {
    ...
    const criticalFindingCount = (0, react_1.useMemo)(() => {
        let count = 0;
        const checkValues = [
            form.underHoodState,
    ...
    const inspectionQuickSections = (0, react_1.useMemo)(() => {
        const sections = [
    ...
    const renderCheckCard = (title, subtitle, fields, noteFields) => ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, borderRadius: 16 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: title }), (0, jsx_runtime_1.jsx)("span", { style: styles.statusNeutral, children: subtitle })] }), (0, jsx_runtime_1.jsx)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: fields.map(([label, key]) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: label }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form[key], onChange: (e) => setForm((prev) => ({
                                ...prev,
                                [key]: e.target.value,
                            })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] })] }, String(key)))) }), noteFields?.length ? ((0, jsx_runtime_1.jsx)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: noteFields.map(([label, key, placeholder]) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: label }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form[key] || "", onChange: (e) => setForm((prev) => ({ ...prev, [key]: e.target.value })), placeholder: placeholder })] }, String(key)))) })) : null] }));
    const renderAdditionalFindingsSection = (category, title, subtitle) => {
        const findings = form[category];
        return ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: title }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: subtitle })] }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: () => addCategoryFinding(category), children: "Add Finding" })] }), findings.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No additional findings added for this category." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: findings.map((finding, findingIndex) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("strong", { children: [title, " Finding ", findingIndex + 1] }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => removeCategoryFinding(category, finding.id), children: "Remove" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Finding Title" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: finding.title, onChange: (e) => updateCategoryFinding(category, finding.id, "title", e.target.value), placeholder: "Example: Cooling fan noisy" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Status" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: finding.status, onChange: (e) => updateCategoryFinding(category, finding.id, "status", e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "OK", children: "OK" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Replace", children: "Replace" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Finding Note" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: finding.note, onChange: (e) => updateCategoryFinding(category, finding.id, "note", e.target.value), placeholder: "Technician note, observation, or explanation" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 4 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Photo / Media Notes" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: () => addCategoryFindingPhotoNote(category, finding.id), children: "Add Photo Note" })] }), finding.photoNotes.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No photo or media notes yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: finding.photoNotes.map((photoNote, photoIndex) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("strong", { children: ["Photo Note ", photoIndex + 1] }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => removeCategoryFindingPhotoNote(category, finding.id, photoIndex), children: "Remove" })] }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: photoNote, onChange: (e) => updateCategoryFindingPhotoNote(category, finding.id, photoIndex, e.target.value), placeholder: "Filename, angle, or evidence note" })] }, `${finding.id}_${photoIndex}`))) }))] })] })] }, finding.id))) }))] }));
    };
    return ((0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [!selectedIntake ? ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(4, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Inspection Queue", subtitle: "Safety check is first. Tires are second by default.", right: (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [eligibleIntakes.length, " in queue"] }), children: eligibleIntakes.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No intake records ready for inspection." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.queueStack, children: eligibleIntakes.map((row) => {
                                const hasInspection = inspectionRecords.some((item) => item.intakeId === row.id);
                                return ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: () => setSelectedIntakeId(row.id), style: styles.queueCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.queueCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.intakeNumber }), hasInspection ? (0, jsx_runtime_1.jsx)("span", { style: (inspectionRecords.find((item) => item.intakeId === row.id)?.status === "Completed") ? styles.statusOk : styles.statusWarning, children: inspectionRecords.find((item) => item.intakeId === row.id)?.status === "Completed" ? "Completed" : "In Progress" }) : (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: "New" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.queueLine, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.queueLineMuted, children: row.companyName || row.customerName || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.queueLineMuted, children: [row.make, row.model, row.year].filter(Boolean).join("  |  ") })] }, row.id));
                            }) })) }) })) : null, !selectedIntake ? ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(8, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)(Card, { title: "Inspection Edit + History Lookup", subtitle: "Search any prior inspection by plate, customer, company, or inspection number and reopen it for editing", right: (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [inspectionHistoryMatches.length, " match(es)"] }), children: [showDraftRestore ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Draft Recovery" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "An unfinished inspection draft was recovered automatically." })] }), (0, jsx_runtime_1.jsx)("span", { style: styles.statusWarning, children: "Recovered" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => setShowDraftRestore(false), children: "Keep Draft" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => { setSelectedIntakeId(""); setForm(getDefaultInspectionForm()); inspectionDraft.clearDraft(); setShowDraftRestore(false); }, children: "Discard Draft" })] })] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Draft Status" }), (0, jsx_runtime_1.jsx)("strong", { children: inspectionDraft.draftState })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "History Search" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search by plate, customer, company, inspection no., make, or concern" })] }), !search.trim() ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Select a vehicle from the queue or search older inspection records to reopen and edit them." })) : inspectionHistoryMatches.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No inspection history found for this search." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: inspectionHistoryMatches.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.inspectionNumber }), (0, jsx_runtime_1.jsx)(InspectionStatusBadge, { status: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.accountLabel }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: [row.make, row.model, row.year].filter(Boolean).join(" ") || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Updated" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(row.updatedAt) })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => setSelectedIntakeId(row.intakeId), children: "Edit Inspection" }) })] }, row.id))) }))] }) })) : null, (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: !selectedIntake ? getResponsiveSpan(12, isCompactLayout) : "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Inspection Form", subtitle: "Safety first, tires second, under the hood always included, brakes triggered", right: selectedIntake ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: () => { setSelectedIntakeId(""); setError(""); }, children: "Change Vehicle" }), selectedInspection ? (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: reopenInspection, children: "Reopen" }) : null, selectedInspection ? (0, jsx_runtime_1.jsx)(InspectionStatusBadge, { status: selectedInspection.status }) : (0, jsx_runtime_1.jsx)("span", { style: styles.statusNeutral, children: "Draft Seeded" })] })) : (selectedInspection ? (0, jsx_runtime_1.jsx)(InspectionStatusBadge, { status: selectedInspection.status }) : (0, jsx_runtime_1.jsx)("span", { style: styles.statusNeutral, children: "Draft Seeded" })), children: !selectedIntake ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "Select an intake from the queue to start inspection." })) : ((0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.inspectionActionBanner, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.inspectionActionSummary, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.inspectionSummaryPill, children: [(0, jsx_runtime_1.jsx)("strong", { children: form.status }), (0, jsx_runtime_1.jsx)("span", { children: "Current status" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inspectionSummaryPill, children: [(0, jsx_runtime_1.jsx)("strong", { children: criticalFindingCount }), (0, jsx_runtime_1.jsx)("span", { children: "Critical items" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inspectionSummaryPill, children: [(0, jsx_runtime_1.jsx)("strong", { children: autoRecommendations.length }), (0, jsx_runtime_1.jsx)("span", { children: "Auto recommendations" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inspectionSummaryPill, children: [(0, jsx_runtime_1.jsx)("strong", { children: form.evidenceItems.length }), (0, jsx_runtime_1.jsx)("span", { children: "Evidence files" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.primaryButton, onClick: () => saveInspection(), children: "Save Draft / Update" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => saveInspection("Completed"), children: "Save as Completed" }), selectedInspection ? ((0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: reopenInspection, children: "Reopen Inspection" })) : null] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Quick Section Navigation" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Jump to the active inspection sections below to reduce scrolling during encoding." }), (0, jsx_runtime_1.jsx)("div", { style: styles.pillWrap, children: inspectionQuickSections.map((section) => ((0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.pillButton, onClick: () => jumpToInspectionSection(section.id), children: section.label }, section.id))) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(4, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { id: "inspection-overview", style: { ...styles.sectionCard, position: isCompactLayout ? "static" : "sticky", top: 16 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Vehicle & Inspection Summary" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryGrid, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Intake No." }), (0, jsx_runtime_1.jsx)("div", { children: selectedIntake.intakeNumber })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Status" }), (0, jsx_runtime_1.jsx)("div", { children: form.status })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Plate" }), (0, jsx_runtime_1.jsx)("div", { children: selectedIntake.plateNumber || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Conduction" }), (0, jsx_runtime_1.jsx)("div", { children: selectedIntake.conductionNumber || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Customer" }), (0, jsx_runtime_1.jsx)("div", { children: selectedIntake.companyName || selectedIntake.customerName || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Vehicle" }), (0, jsx_runtime_1.jsx)("div", { children: [selectedIntake.make, selectedIntake.model, selectedIntake.year].filter(Boolean).join(" ") || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Odometer" }), (0, jsx_runtime_1.jsx)("div", { children: selectedIntake.odometerKm || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Overall Under Hood" }), (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)("span", { style: getCheckValueStyle(overallUnderhoodLabel), children: overallUnderhoodLabel }) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.concernBanner, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Concern:" }), " ", selectedIntake.concern] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Inspection Status" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.status, onChange: (e) => setForm((prev) => ({ ...prev, status: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "In Progress", children: "In Progress" }), (0, jsx_runtime_1.jsx)("option", { value: "Completed", children: "Completed" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Overall Under the Hood State" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.underHoodState, onChange: (e) => setForm((prev) => ({ ...prev, underHoodState: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Photo Evidence / Photo Notes" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.inspectionPhotoNotes, onChange: (e) => setForm((prev) => ({ ...prev, inspectionPhotoNotes: e.target.value })), placeholder: "File names, camera refs, or note about captured photos" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Under the Hood Summary" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textareaLarge, value: form.underHoodSummary, onChange: (e) => setForm((prev) => ({ ...prev, underHoodSummary: e.target.value })), placeholder: "Required technician write-up" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Recommended Work / Findings" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: form.recommendedWork, onChange: (e) => setForm((prev) => ({ ...prev, recommendedWork: e.target.value })), placeholder: "Manual notes are merged with auto recommendations" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Auto Recommendations" }), autoRecommendations.length ? ((0, jsx_runtime_1.jsx)("div", { style: styles.quickAccessList, children: autoRecommendations.map((item) => ((0, jsx_runtime_1.jsx)("div", { style: styles.quickAccessRow, children: (0, jsx_runtime_1.jsx)("span", { children: item }) }, item))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No automatic recommendations yet." }))] }), selectedInspection ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Edit Mode" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Editing ", selectedInspection.inspectionNumber, "  |  Created ", formatDateTime(selectedInspection.createdAt), "  |  Last updated ", formatDateTime(selectedInspection.updatedAt), selectedInspection.lastUpdatedBy ? ` by ${selectedInspection.lastUpdatedBy}` : ""] })] })) : null, relatedInspectionHistory.length ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Related Vehicle / Customer History" }), (0, jsx_runtime_1.jsx)("div", { style: styles.quickAccessList, children: relatedInspectionHistory.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.quickAccessRow, children: [(0, jsx_runtime_1.jsxs)("span", { children: [row.inspectionNumber, "  |  ", row.plateNumber || row.conductionNumber || "-"] }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(row.updatedAt) })] }, row.id))) })] })) : null, error ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: error }) : null, (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.stickyActionBar : styles.inlineActionsColumn, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.primaryButton, width: "100%" }, onClick: () => saveInspection(), children: "Save Draft / Update" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.smallButtonSuccess, width: "100%" }, onClick: () => saveInspection("Completed"), children: "Mark Complete" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: { ...styles.secondaryButton, width: "100%" }, onClick: () => setForm(getDefaultInspectionForm()), children: "Reset Working Form" })] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(8, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 16 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.toggleGrid, children: [(0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableSafetyChecks, onChange: (e) => setForm((prev) => ({ ...prev, enableSafetyChecks: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Arrival / Safety Checks" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableTires, onChange: (e) => setForm((prev) => ({ ...prev, enableTires: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Tire Inspection" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableBrakes, onChange: (e) => setForm((prev) => ({ ...prev, enableBrakes: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Brake Inspection" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableSuspensionCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableSuspensionCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Suspension Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableAlignmentCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableAlignmentCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Alignment Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableCoolingCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableCoolingCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Cooling System Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableSteeringCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableSteeringCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Steering Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableEnginePerformanceCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableEnginePerformanceCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Engine Performance Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableRoadTestCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableRoadTestCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Road Test Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableAcCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableAcCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable A/C Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableElectricalCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableElectricalCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Electrical Check" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.enableScanCheck, onChange: (e) => setForm((prev) => ({ ...prev, enableScanCheck: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Enable Scan / OBD2 Check" })] })] }), form.enableSafetyChecks ? ((0, jsx_runtime_1.jsxs)("div", { id: "inspection-arrival", style: { ...styles.sectionCard, marginTop: 16, background: "#eff6ff", border: "1px solid #bfdbfe" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Arrival / Safety Checks" }), (0, jsx_runtime_1.jsx)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [
                                                                    ["Lights", "arrivalLights"],
                                                                    ["Broken Glass", "arrivalBrokenGlass"],
                                                                    ["Wipers", "arrivalWipers"],
                                                                    ["Horn", "arrivalHorn"],
                                                                ].map(([label, key]) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: label }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form[key], onChange: (e) => setForm((prev) => ({
                                                                                ...prev,
                                                                                [key]: e.target.value,
                                                                            })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] }), (0, jsx_runtime_1.jsx)("span", { style: getCheckValueStyle(form[key]), children: form[key] })] }, key))) }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Warning Lights at Arrival" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Document warning lights before scanning so the shop has an arrival record." }), (0, jsx_runtime_1.jsx)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [
                                                                            ...
                                                                            ["Other Warning", "arrivalOtherWarningLight"],
                                                                                        ...
                                                                                        ...prev,
                                                                                        [key]: e.target.value,
                                                                                    })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Off", children: "Off" }), (0, jsx_runtime_1.jsx)("option", { value: "On", children: "On" })] }), (0, jsx_runtime_1.jsx)("span", { style: getWarningLightStyle(form[key]), children: form[key] })] }, key))) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Other Warning Light Note" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.arrivalOtherWarningNote, onChange: (e) => setForm((prev) => ({ ...prev, arrivalOtherWarningNote: e.target.value })), placeholder: "Cluster message, icon name, or customer warning-light note" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Exterior Photo Slots" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Save notes, filenames, or placeholders for required exterior photos. Additional findings can be added manually when needed." }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Front Photo" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.arrivalFrontPhotoNote, onChange: (e) => setForm((prev) => ({ ...prev, arrivalFrontPhotoNote: e.target.value })), placeholder: "Filename, note, or placeholder" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Driver Side Photo" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.arrivalDriverSidePhotoNote, onChange: (e) => setForm((prev) => ({ ...prev, arrivalDriverSidePhotoNote: e.target.value })), placeholder: "Filename, note, or placeholder" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Rear Photo" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.arrivalRearPhotoNote, onChange: (e) => setForm((prev) => ({ ...prev, arrivalRearPhotoNote: e.target.value })), placeholder: "Filename, note, or placeholder" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Passenger Side Photo" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.arrivalPassengerSidePhotoNote, onChange: (e) => setForm((prev) => ({ ...prev, arrivalPassengerSidePhotoNote: e.target.value })), placeholder: "Filename, note, or placeholder" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Additional Findings Photo Slots" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: addAdditionalFindingPhotoNote, children: "Add Optional Slot" })] }), form.additionalFindingPhotoNotes.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No optional findings photo slots added yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: form.additionalFindingPhotoNotes.map((item, index) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("strong", { children: ["Finding Photo Slot ", index + 1] }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => removeAdditionalFindingPhotoNote(index), children: "Remove" })] }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: item, onChange: (e) => updateAdditionalFindingPhotoNote(index, e.target.value), placeholder: "Optional filename, location, or note" })] }, `finding_photo_${index}`))) }))] })] })] })) : null, form.enableTires ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#ecfdf5", border: "1px solid #a7f3d0" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Tire Inspection" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Front Left Tread (mm)" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.frontLeftTreadMm, onChange: (e) => setForm((prev) => ({ ...prev, frontLeftTreadMm: e.target.value })) }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.frontLeftTireState, onChange: (e) => setForm((prev) => ({ ...prev, frontLeftTireState: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.frontLeftWearPattern, onChange: (e) => setForm((prev) => ({ ...prev, frontLeftWearPattern: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Even Wear", children: "Even Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Inner Wear", children: "Inner Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Outer Wear", children: "Outer Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Center Wear", children: "Center Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Uneven Wear", children: "Uneven Wear" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Front Right Tread (mm)" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.frontRightTreadMm, onChange: (e) => setForm((prev) => ({ ...prev, frontRightTreadMm: e.target.value })) }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.frontRightTireState, onChange: (e) => setForm((prev) => ({ ...prev, frontRightTireState: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.frontRightWearPattern, onChange: (e) => setForm((prev) => ({ ...prev, frontRightWearPattern: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Even Wear", children: "Even Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Inner Wear", children: "Inner Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Outer Wear", children: "Outer Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Center Wear", children: "Center Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Uneven Wear", children: "Uneven Wear" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Rear Left Tread (mm)" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.rearLeftTreadMm, onChange: (e) => setForm((prev) => ({ ...prev, rearLeftTreadMm: e.target.value })) }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.rearLeftTireState, onChange: (e) => setForm((prev) => ({ ...prev, rearLeftTireState: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.rearLeftWearPattern, onChange: (e) => setForm((prev) => ({ ...prev, rearLeftWearPattern: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Even Wear", children: "Even Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Inner Wear", children: "Inner Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Outer Wear", children: "Outer Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Center Wear", children: "Center Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Uneven Wear", children: "Uneven Wear" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Rear Right Tread (mm)" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.rearRightTreadMm, onChange: (e) => setForm((prev) => ({ ...prev, rearRightTreadMm: e.target.value })) }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.rearRightTireState, onChange: (e) => setForm((prev) => ({ ...prev, rearRightTireState: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.rearRightWearPattern, onChange: (e) => setForm((prev) => ({ ...prev, rearRightWearPattern: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Even Wear", children: "Even Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Inner Wear", children: "Inner Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Outer Wear", children: "Outer Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Center Wear", children: "Center Wear" }), (0, jsx_runtime_1.jsx)("option", { value: "Uneven Wear", children: "Uneven Wear" })] })] })] })] })] })) : null, (0, jsx_runtime_1.jsxs)("div", { id: "inspection-underhood", style: styles.sectionCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Detailed Under the Hood" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Clean grouped cards for a more professional technician workflow. Notes stay beside the related checks." }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [renderCheckCard("Fluids", "Core checks", fluidsFields, [
                                                                    ...
                                                                    ])] })] }), form.enableSuspensionCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#f5f3ff", border: "1px solid #ddd6fe" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Suspension Check" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Expanded suspension coverage for cars, SUVs, and pickups. Alignment is recommended when steering or suspension issues are found." }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [renderCheckCard("Front Steering / Linkage", "Steering rack, tie rods, ball joints, and linkage", [
                                                                    ...
                                                                    ]) : null] })] })) : null, form.enableAlignmentCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#ecfeff", border: "1px solid #a5f3fc" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Alignment Check" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Upload or capture the before alignment printout. After printout is optional for later." }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Alignment Concern / Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: form.alignmentConcernNotes, onChange: (e) => setForm((prev) => ({ ...prev, alignmentConcernNotes: e.target.value })), placeholder: "Pulling left/right, steering wheel off-center, uneven tire wear, customer request, or technician observation" })] }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxCard, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.alignmentRecommended, onChange: (e) => setForm((prev) => ({ ...prev, alignmentRecommended: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Recommend Wheel Alignment" })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Before Alignment Printout" }), (0, jsx_runtime_1.jsx)("input", { type: "file", style: styles.input, onChange: (e) => setForm((prev) => ({
                                                                                    ...prev,
                                                                                    alignmentBeforePrintoutName: e.target.files?.[0]?.name || prev.alignmentBeforePrintoutName || "",
                                                                                })) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Saved file: ", form.alignmentBeforePrintoutName || "No file selected"] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "After Alignment Printout" }), (0, jsx_runtime_1.jsx)("input", { type: "file", style: styles.input, onChange: (e) => setForm((prev) => ({
                                                                                    ...prev,
                                                                                    alignmentAfterPrintoutName: e.target.files?.[0]?.name || prev.alignmentAfterPrintoutName || "",
                                                                                })) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Optional for later: ", form.alignmentAfterPrintoutName || "No file selected"] })] })] })] })) : null, form.enableCoolingCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#eff6ff", border: "1px solid #bfdbfe" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Cooling System Inspection" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Use this trigger for overheating, coolant loss, fan concern, radiator issue, or cooling-system complaint." }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: renderCheckCard("Cooling Components", "Fan, radiator, pump, thermostat, and pressure-related checks", [
                                                                ...
                                                                ], [["Steering Notes", "steeringSystemNotes", "Hard steering, wandering, free play, leak, assist issue, noise"]]) })] })) : null, form.enableEnginePerformanceCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#fff7ed", border: "1px solid #fdba74" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Engine Performance Inspection" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Use this trigger for rough idle, weak power, misfire, smoke, hesitation, poor fuel economy, or drivability concerns." }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: renderCheckCard("Engine Performance", "Starting, idle, response, misfire, smoke, and economy-related checks", [
                                                                ...
                                                                ], [["Engine Performance Notes", "enginePerformanceNotes", "Hard start, rough idle, hesitation, smoke color, power loss"]]) })] })) : null, form.enableRoadTestCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#ecfeff", border: "1px solid #a5f3fc" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Road Test Inspection" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Use this trigger for issues that only appear while driving, including noises, pull, brake feel, ride quality, and shift behavior." }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: renderCheckCard("Road Test Findings", "Noise, braking, steering tracking, ride quality, acceleration, and shift feel", [
                                                                ...
                                                                ], [["Road Test Notes", "roadTestNotes", "Pulling, vibration, clunk, delayed shift, harsh brake feel, rough ride"]]) })] })) : null, form.enableAcCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#ecfdf5", border: "1px solid #a7f3d0" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "A/C Inspection" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Use this triggered section for weak cooling, bad smell, noisy compressor, poor airflow, or customer-requested A/C checks." }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Vent Temperature" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.acVentTemperature, onChange: (e) => setForm((prev) => ({ ...prev, acVentTemperature: e.target.value })), placeholder: "Example: 8\u00B0C or 46\u00B0F" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "A/C Notes" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.acNotes, onChange: (e) => setForm((prev) => ({ ...prev, acNotes: e.target.value })), placeholder: "Weak cooling, noisy clutch, odor, intermittent cooling" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [renderCheckCard("Cooling / Compressor", "Core A/C checks", [
                                                                    ...
                                                                    ])] })] })) : null, form.enableElectricalCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#eff6ff", border: "1px solid #facc15", boxShadow: "0 0 0 1px rgba(239,68,68,0.05) inset" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Electrical Inspection" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Use this triggered section for no-start, weak battery, warning lights, intermittent electrical faults, or charging complaints." }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Battery Voltage" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.electricalBatteryVoltage, onChange: (e) => setForm((prev) => ({ ...prev, electricalBatteryVoltage: e.target.value })), placeholder: "Example: 12.6V" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Charging Voltage" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.electricalChargingVoltage, onChange: (e) => setForm((prev) => ({ ...prev, electricalChargingVoltage: e.target.value })), placeholder: "Example: 13.8V to 14.5V" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [renderCheckCard("Starting / Charging", "Battery, starter, and alternator checks", [
                                                                    ...
                                                                    ], [["Transmission Notes", "transmissionNotes", "Slipping, delayed shift, hard shift, vibration, noise, clutch feel"]])] })] })) : null, form.enableScanCheck ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#ecfeff", border: "1px solid #a5f3fc" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Scan / OBD2 Check" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Upload OBD2 scan results as PDF or photo. Use this for warning lights, diagnostic documentation, and before/after scan proof." }), (0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxCard, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.scanPerformed, onChange: (e) => setForm((prev) => ({ ...prev, scanPerformed: e.target.checked })) }), (0, jsx_runtime_1.jsx)("span", { children: "Scan Performed" })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Scanner Used" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.scanToolUsed, onChange: (e) => setForm((prev) => ({ ...prev, scanToolUsed: e.target.value })), placeholder: "Autel, Launch, Bosch, OEM tool, mobile scanner, etc." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Upload Scan Result" }), (0, jsx_runtime_1.jsx)("input", { type: "file", style: styles.input, accept: ".pdf,image/*", multiple: true, onChange: (e) => addScanUploadNames(e.target.files) }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Accepted: PDF, photos, screenshots of scan results." })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Scan Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: form.scanNotes, onChange: (e) => setForm((prev) => ({ ...prev, scanNotes: e.target.value })), placeholder: "Scanner notes, pending codes, freeze-frame note, cleared / not cleared, or customer explanation" })] }), form.scanUploadNames.length ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Uploaded Scan Results" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: form.scanUploadNames.map((fileName, index) => ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataCard, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: fileName }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => removeScanUploadName(index), children: "Remove" })] }) }, `${fileName}_${index}`))) })] })) : null] })) : null, form.enableBrakes ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16, background: "#fff1f2", border: "1px solid #fecdd3" }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Brake Inspection" }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Front Brake Condition" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.frontBrakeCondition, onChange: (e) => setForm((prev) => ({ ...prev, frontBrakeCondition: e.target.value })), placeholder: "Good / Needs attention / Bad" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.frontBrakeState, onChange: (e) => setForm((prev) => ({ ...prev, frontBrakeState: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Rear Brake Condition" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.rearBrakeCondition, onChange: (e) => setForm((prev) => ({ ...prev, rearBrakeCondition: e.target.value })), placeholder: "Good / Needs attention / Bad" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.rearBrakeState, onChange: (e) => setForm((prev) => ({ ...prev, rearBrakeState: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Not Checked", children: "Not Checked" }), (0, jsx_runtime_1.jsx)("option", { value: "Good", children: "Good" }), (0, jsx_runtime_1.jsx)("option", { value: "Monitor", children: "Monitor" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Attention", children: "Needs Attention" }), (0, jsx_runtime_1.jsx)("option", { value: "Needs Replacement", children: "Needs Replacement" })] })] })] })] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginTop: 16 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "General Inspection Notes" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Inspection Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: form.inspectionNotes, onChange: (e) => setForm((prev) => ({ ...prev, inspectionNotes: e.target.value })), placeholder: "Additional notes" })] })] })] }) })] })] })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsxs)(Card, { title: "Inspection Registry", subtitle: "Saved inspections linked to intake records", right: (0, jsx_runtime_1.jsxs)("span", { style: styles.statusNeutral, children: [filteredInspectionRecords.length, " saved"] }), children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Search" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search inspection no, intake no, plate, customer, vehicle, concern" })] }), filteredInspectionRecords.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No inspections saved yet." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: filteredInspectionRecords.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.inspectionNumber }), (0, jsx_runtime_1.jsx)(InspectionStatusBadge, { status: row.status })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: ["Linked Intake: ", row.intakeNumber] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.accountLabel }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: [row.make, row.model, row.year, row.color].filter(Boolean).join("  |  ") || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Evidence: ", row.evidenceItems?.length || 0] }), (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: row.underHoodSummary || "No under the hood summary." })] }, row.id))) })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.tableWrap, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Inspection No." }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Linked Intake" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Plate / Customer" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Vehicle" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Default Category" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Evidence" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Status" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: filteredInspectionRecords.map((row) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsxs)("td", { style: styles.td, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.tablePrimary, children: row.inspectionNumber }), (0, jsx_runtime_1.jsx)("div", { style: styles.tableSecondary, children: formatDateTime(row.createdAt) })] }), (0, jsx_runtime_1.jsxs)("td", { style: styles.td, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.tablePrimary, children: row.intakeNumber }), (0, jsx_runtime_1.jsx)("div", { style: styles.tableSecondary, children: row.concern || "-" })] }), (0, jsx_runtime_1.jsxs)("td", { style: styles.td, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.tablePrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.tableSecondary, children: row.accountLabel })] }), (0, jsx_runtime_1.jsxs)("td", { style: styles.td, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.tablePrimary, children: [row.make, row.model].filter(Boolean).join(" ") || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.tableSecondary, children: [row.year, row.color, row.odometerKm && `${row.odometerKm} km`].filter(Boolean).join("  |  ") })] }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: (0, jsx_runtime_1.jsx)("div", { style: styles.concernCell, children: row.underHoodSummary }) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: row.evidenceItems?.length || 0 }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: (0, jsx_runtime_1.jsx)(InspectionStatusBadge, { status: row.status }) })] }, row.id))) })] }) }))] }) })] }) }));
}
function RepairOrdersPage({ currentUser, users, intakeRecords, inspectionRecords, repairOrders, setRepairOrders, setIntakeRecords, approvalRecords, setApprovalRecords, backjobRecords, setBackjobRecords, partsRequests, releaseRecords, approvalLinkTokens, autoPortalMessage, smsApprovalLogs, onGenerateSmsApprovalLink, onOpenDemoCustomerApprovalLink, onSendSmsTemplate, onRevokeApprovalLink, isCompactLayout, }) {
    const [creationMode, setCreationMode] = (0, react_1.useState)("Intake");
    const [selectedIntakeId, setSelectedIntakeId] = (0, react_1.useState)("");
    const [selectedRoId, setSelectedRoId] = (0, react_1.useState)("");
    const [form, setForm] = (0, react_1.useState)(() => getDefaultRepairOrderForm(currentUser.fullName));
    const [search, setSearch] = (0, react_1.useState)("");
    const [error, setError] = (0, react_1.useState)("");
    const [approvalSummary, setApprovalSummary] = (0, react_1.useState)("");
    const [approvalCommHook, setApprovalCommHook] = (0, react_1.useState)("SMS / Email placeholder");
    const [approvalPreviewMode, setApprovalPreviewMode] = (0, react_1.useState)("Advisor");
    const [backjobComplaint, setBackjobComplaint] = (0, react_1.useState)("");
    const [backjobRootCause, setBackjobRootCause] = (0, react_1.useState)("");
    const [backjobOutcome, setBackjobOutcome] = (0, react_1.useState)("Customer Pay");
    const [backjobResolutionNotes, setBackjobResolutionNotes] = (0, react_1.useState)("");
    const smsProviderDefaults = getSmsProviderConfig();
    const [smsProviderMode, setSmsProviderMode] = (0, react_1.useState)(smsProviderDefaults.mode);
    const [smsAndroidGatewayUrl, setSmsAndroidGatewayUrl] = (0, react_1.useState)(smsProviderDefaults.gatewayUrl);
    const [smsAndroidGatewayApiKey, setSmsAndroidGatewayApiKey] = (0, react_1.useState)(smsProviderDefaults.authToken);
    const [smsAndroidSenderDeviceLabel, setSmsAndroidSenderDeviceLabel] = (0, react_1.useState)(smsProviderDefaults.senderDeviceLabel);
    const [smsTwilioAccountSid, setSmsTwilioAccountSid] = (0, react_1.useState)(smsProviderDefaults.twilioAccountSid);
    const [smsTwilioFromNumber, setSmsTwilioFromNumber] = (0, react_1.useState)(smsProviderDefaults.twilioFromNumber);
    const [smsProviderConfigFeedback, setSmsProviderConfigFeedback] = (0, react_1.useState)("");
    const [isCreatingRO, setIsCreatingRO] = (0, react_1.useState)(false);
    const [isSavingSmsProviderSettings, setIsSavingSmsProviderSettings] = (0, react_1.useState)(false);
    const [isGeneratingApprovalLink, setIsGeneratingApprovalLink] = (0, react_1.useState)(false);
    const [resendingSmsLogId, setResendingSmsLogId] = (0, react_1.useState)("");
    const [draftRecommendationTitles, setDraftRecommendationTitles] = (0, react_1.useState)([]);
    const [roRecommendationTitlesById, setRoRecommendationTitlesById] = (0, react_1.useState)({});
    const [dismissedMileageSuggestionIdsByScope, setDismissedMileageSuggestionIdsByScope] = (0, react_1.useState)({});
    const sortedRepairOrders = (0, react_1.useMemo)(() => repairOrders, [repairOrders]);
    const availableIntakes = (0, react_1.useMemo)(() => {
    ...
    const selectedIntake = (0, react_1.useMemo)(() => availableIntakes.find((row) => row.id === selectedIntakeId) ?? null, [availableIntakes, selectedIntakeId]);
    const linkedInspection = (0, react_1.useMemo)(() => {
        if (!selectedIntake)
            return null;
        return inspectionRecords.find((row) => row.intakeId === selectedIntake.id) ?? null;
    }, [inspectionRecords, selectedIntake]);
    const selectedRO = (0, react_1.useMemo)(() => sortedRepairOrders.find((row) => row.id === selectedRoId) ?? null, [sortedRepairOrders, selectedRoId]);
    const draftMaintenanceSuggestions = (0, react_1.useMemo)(() => getUnifiedMaintenanceSuggestions({
        make: form.make,
        model: form.model,
        year: form.year,
    ...
    const selectedROMaintenanceSuggestions = (0, react_1.useMemo)(() => selectedRO
    ...
    const selectedApproval = (0, react_1.useMemo)(() => selectedRO
        ? approvalRecords
            .filter((row) => row.roId === selectedRO.id)
            .sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())[0] ?? null
        : null, [approvalRecords, selectedRO]);
    const selectedBackjobs = (0, react_1.useMemo)(() => selectedRO
        ? backjobRecords
            .filter((row) => row.linkedRoId === selectedRO.id)
            .sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
        : [], [backjobRecords, selectedRO]);
    const selectedPartsRequests = (0, react_1.useMemo)(() => selectedRO
        ? partsRequests
            .filter((row) => row.roId === selectedRO.id)
            .sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
        : [], [partsRequests, selectedRO]);
    const selectedReleaseRecord = (0, react_1.useMemo)(() => selectedRO
        ? releaseRecords.find((row) => row.roId === selectedRO.id) ?? null
        : null, [releaseRecords, selectedRO]);
    const latestVehicleOdometerByKey = (0, react_1.useMemo)(() => {
    ...
    const oilChangeReminders = (0, react_1.useMemo)(() => {
        const reminders = [];
    ...
    const releaseFollowUpReminders = (0, react_1.useMemo)(() => {
        const reminders = [];
    ...
    const [selectedOilReminderVehicleKey, setSelectedOilReminderVehicleKey] = (0, react_1.useState)("");
    const [selectedFollowUpVehicleKey, setSelectedFollowUpVehicleKey] = (0, react_1.useState)("");
    const activeOilChangeReminder = (0, react_1.useMemo)(() => {
    ...
    const activeReleaseFollowUpReminder = (0, react_1.useMemo)(() => {
    ...
    const activeApprovalLinkToken = (0, react_1.useMemo)(() => (selectedRO ? getLatestActiveApprovalLinkForRo(approvalLinkTokens, selectedRO.id) : null), [approvalLinkTokens, selectedRO]);
    const selectedROInspection = (0, react_1.useMemo)(() => selectedRO
    ...
    const findingRecommendations = (0, react_1.useMemo)(() => {
    ...
    const customerApprovalMessage = (0, react_1.useMemo)(() => buildCustomerApprovalMessage(selectedRO), [selectedRO]);
    const [notificationTemplateKey, setNotificationTemplateKey] = (0, react_1.useState)("approval-request");
    const [sendingSmsKey, setSendingSmsKey] = (0, react_1.useState)("");
    const [smsSendFeedback, setSmsSendFeedback] = (0, react_1.useState)("");
    const customerNotificationTemplates = (0, react_1.useMemo)(() => buildCustomerNotificationTemplates({
        ro: selectedRO,
    ...
    const activeCustomerNotificationTemplateSendable = (0, react_1.useMemo)(() => {
    ...
    const activeCustomerNotificationSmsPayload = (0, react_1.useMemo)(() => {
    ...
    const primaryTechnicians = (0, react_1.useMemo)(() => users.filter((user) => user.active &&
        ["Chief Technician", "Senior Mechanic", "General Mechanic"].includes(user.role)), [users]);
    const supportTechnicians = (0, react_1.useMemo)(() => users.filter((user) => user.active &&
        ["Chief Technician", "Senior Mechanic", "General Mechanic", "OJT"].includes(user.role)), [users]);
    const filteredRepairOrders = (0, react_1.useMemo)(() => {
        const term = search.trim().toLowerCase();
        if (!term)
    ...
    const roSummary = (0, react_1.useMemo)(() => ({
    ...
    const draftMaintenanceSuggestionGroups = (0, react_1.useMemo)(() => groupSuggestionsByCategory(draftMaintenanceSuggestions), [draftMaintenanceSuggestions]);
    const selectedROMaintenanceSuggestionGroups = (0, react_1.useMemo)(() => groupSuggestionsByCategory(selectedROMaintenanceSuggestions), [selectedROMaintenanceSuggestions]);
    (0, react_1.useEffect)(() => {
        setForm((prev) => ({
            ...prev,
    ...
    const selectedROTotal = selectedRO
        ? selectedRO.workLines.reduce((sum, line) => sum + parseMoneyInput(line.totalEstimate), 0)
        : 0;
    return ((0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(5, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Create Repair Order", subtitle: "Create from intake or manually without an intake record", right: (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: "Option A Enabled" }), children: (0, jsx_runtime_1.jsxs)("form", { onSubmit: handleCreateRO, style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Creation Mode" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: creationMode, onChange: (e) => {
                                                        setCreationMode(e.target.value);
                                                        setSelectedIntakeId("");
                                                        setForm(getDefaultRepairOrderForm(currentUser.fullName));
                                                    }, children: [(0, jsx_runtime_1.jsx)("option", { value: "Intake", children: "From Existing Intake" }), (0, jsx_runtime_1.jsx)("option", { value: "Manual", children: "Manual RO Without Intake" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "RO Status" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.status, onChange: (e) => setForm((prev) => ({ ...prev, status: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Draft", children: "Draft" }), (0, jsx_runtime_1.jsx)("option", { value: "Waiting Inspection", children: "Waiting Inspection" }), (0, jsx_runtime_1.jsx)("option", { value: "Waiting Approval", children: "Waiting Approval" }), (0, jsx_runtime_1.jsx)("option", { value: "Approved / Ready to Work", children: "Approved / Ready to Work" })] })] })] }), creationMode === "Intake" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Select Intake" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: selectedIntakeId, onChange: (e) => setSelectedIntakeId(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Select intake record" }), availableIntakes.map((row) => ((0, jsx_runtime_1.jsxs)("option", { value: row.id, children: [row.intakeNumber, "  |  ", row.plateNumber || row.conductionNumber || "No Plate", "  |  ", row.companyName || row.customerName || "Unknown"] }, row.id)))] })] })) : null, creationMode === "Intake" && selectedIntake ? ((0, jsx_runtime_1.jsx)("div", { style: styles.summaryPanel, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryGrid, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Intake No.:" }), " ", selectedIntake.intakeNumber] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Inspection:" }), " ", linkedInspection?.inspectionNumber || "None linked"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Plate:" }), " ", selectedIntake.plateNumber || "-"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Account:" }), " ", selectedIntake.companyName || selectedIntake.customerName || "-"] })] }) })) : null, (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Account Type" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.accountType, onChange: (e) => setForm((prev) => ({ ...prev, accountType: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "Personal", children: "Personal" }), (0, jsx_runtime_1.jsx)("option", { value: "Company / Fleet", children: "Company / Fleet" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Service Advisor" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.advisorName, onChange: (e) => setForm((prev) => ({ ...prev, advisorName: e.target.value })), placeholder: "Advisor or reception encoder" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: form.accountType === "Company / Fleet" ? "Company / Fleet Name" : "Customer Name" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.accountType === "Company / Fleet" ? form.companyName : form.customerName, onChange: (e) => setForm((prev) => prev.accountType === "Company / Fleet"
                                                ? { ...prev, companyName: e.target.value }
                                                : { ...prev, customerName: e.target.value }), placeholder: form.accountType === "Company / Fleet" ? "Enter company or fleet name" : "Enter customer name" })] }), form.accountType === "Company / Fleet" ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Driver / Contact Person" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.customerName, onChange: (e) => setForm((prev) => ({ ...prev, customerName: e.target.value })), placeholder: "Optional driver or contact person" })] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Phone" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.phone, onChange: (e) => setForm((prev) => ({ ...prev, phone: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Email" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.email, onChange: (e) => setForm((prev) => ({ ...prev, email: e.target.value })) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Plate Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.plateNumber, onChange: (e) => setForm((prev) => ({ ...prev, plateNumber: e.target.value.toUpperCase() })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Conduction Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.conductionNumber, onChange: (e) => setForm((prev) => ({ ...prev, conductionNumber: e.target.value.toUpperCase() })) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Make" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.make, onChange: (e) => setForm((prev) => ({ ...prev, make: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Model" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.model, onChange: (e) => setForm((prev) => ({ ...prev, model: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Year" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.year, onChange: (e) => setForm((prev) => ({ ...prev, year: e.target.value })) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Color" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.color, onChange: (e) => setForm((prev) => ({ ...prev, color: e.target.value })) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Odometer KM" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: form.odometerKm, onChange: (e) => setForm((prev) => ({ ...prev, odometerKm: e.target.value })) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.sectionTitle, children: ["Maintenance Suggestions ", form.odometerKm.trim() ? `(${form.odometerKm.trim()} km)` : '(KM pending)'] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Unified mileage + library matches. More specific vehicle matches appear first when they overlap." })] }), (0, jsx_runtime_1.jsxs)("span", { style: draftMaintenanceSuggestions.length ? styles.statusInfo : styles.statusNeutral, children: [draftMaintenanceSuggestions.length, " Visible"] })] }), draftMaintenanceSuggestionGroups.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No matching maintenance suggestions for the current vehicle input." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: draftMaintenanceSuggestionGroups.map((group) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.concernCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: group.category }), (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [group.items.length, " suggestions"] })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: group.items.map((item) => {
                                                            ...
                                                            return ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: item.title }), (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: item.intervalTag })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.chipWrap, children: (0, jsx_runtime_1.jsx)("span", { style: styles.tagNeutral, children: item.specificityTag || "General" }) }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: item.reason }), item.isConditional ? (0, jsx_runtime_1.jsx)("div", { style: { ...styles.statusWarning, marginTop: 6 }, children: "If applicable" }) : null, (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.inlineActions, marginTop: 8 }, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, disabled: existsInRecommendations, onClick: () => addDraftSuggestionToRecommendations(item), children: "Add to Recommendations" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, disabled: existsInWorkLines, onClick: () => addDraftSuggestionToWorkLine(item), children: "Add to Work Line" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => dismissMileageSuggestion('draft', item.id), children: "Dismiss" })] })] }, item.id));
                                                        }) })] }, group.category))) })), draftRecommendationTitles.length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Recommendations" }), (0, jsx_runtime_1.jsx)("div", { style: styles.chipWrap, children: draftRecommendationTitles.map((title) => ((0, jsx_runtime_1.jsx)("span", { style: styles.tagNeutral, children: title }, title))) })] })) : null] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Customer Concern" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: form.customerConcern, onChange: (e) => setForm((prev) => ({ ...prev, customerConcern: e.target.value })), placeholder: "Main complaint or requested work" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Work Lines" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: form.workLines.map((line, index) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("strong", { children: ["Line ", index + 1] }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => removeDraftWorkLine(line.id), children: "Remove" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Title" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.title, onChange: (e) => updateDraftLine(line.id, "title", e.target.value), placeholder: "Example: Brake Cleaning" })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Category" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.category, onChange: (e) => updateDraftLine(line.id, "category", e.target.value), placeholder: "Engine, Electrical, Suspension" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Priority" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: line.priority, onChange: (e) => updateDraftLine(line.id, "priority", e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "Low", children: "Low" }), (0, jsx_runtime_1.jsx)("option", { value: "Medium", children: "Medium" }), (0, jsx_runtime_1.jsx)("option", { value: "High", children: "High" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Line Status" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: line.status, onChange: (e) => updateDraftLine(line.id, "status", e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "Pending", children: "Pending" }), (0, jsx_runtime_1.jsx)("option", { value: "In Progress", children: "In Progress" }), (0, jsx_runtime_1.jsx)("option", { value: "Waiting Parts", children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("option", { value: "Completed", children: "Completed" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Service Estimate (PHP)" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.serviceEstimate, onChange: (e) => updateDraftLine(line.id, "serviceEstimate", e.target.value) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Parts Estimate (PHP)" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.partsEstimate, onChange: (e) => updateDraftLine(line.id, "partsEstimate", e.target.value) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Total Estimate" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: formatCurrency(parseMoneyInput(line.totalEstimate)), readOnly: true })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: line.notes, onChange: (e) => updateDraftLine(line.id, "notes", e.target.value) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Customer Description" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: line.customerDescription, onChange: (e) => updateDraftLine(line.id, "customerDescription", e.target.value), placeholder: "Customer-facing explanation for approval preview" })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid4, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Labor Hours" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.laborHours, onChange: (e) => updateDraftLine(line.id, "laborHours", e.target.value), placeholder: "e.g. 1.5" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Labor Rate" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.laborRate, onChange: (e) => updateDraftLine(line.id, "laborRate", e.target.value), placeholder: "PHP per hour" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Parts Cost" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.partsCost, onChange: (e) => updateDraftLine(line.id, "partsCost", e.target.value), placeholder: "Internal / base parts cost" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Markup %" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.partsMarkupPercent, onChange: (e) => updateDraftLine(line.id, "partsMarkupPercent", e.target.value), placeholder: "e.g. 25" })] })] })] })] }, line.id))) }), (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: addDraftWorkLine, children: "Add Work Line" }) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Technician Assignment" }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Primary Technician" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: form.primaryTechnicianId, onChange: (e) => setForm((prev) => ({ ...prev, primaryTechnicianId: e.target.value })), children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Unassigned" }), primaryTechnicians.map((user) => ((0, jsx_runtime_1.jsxs)("option", { value: user.id, children: [user.fullName, "  |  ", user.role] }, user.id)))] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "OJT cannot be assigned as primary technician." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Supporting Technicians" }), (0, jsx_runtime_1.jsx)("div", { style: styles.checkboxList, children: supportTechnicians.map((user) => ((0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxTile, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: form.supportTechnicianIds.includes(user.id), onChange: () => handleSupportToggle(user.id) }), (0, jsx_runtime_1.jsxs)("span", { children: [user.fullName, "  |  ", user.role] })] }, user.id))) })] })] })] }), error ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: error }) : null, (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.stickyActionBar : styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "submit", style: styles.primaryButton, disabled: isCreatingRO, children: "Create RO" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: resetForm, children: "Reset" })] })] }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(7, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)(Card, { title: "Repair Order Registry", subtitle: "Newest to oldest, with live mobile-friendly detail editing", right: (0, jsx_runtime_1.jsxs)("span", { style: styles.statusNeutral, children: [repairOrders.length, " total"] }), children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Search" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search RO no., plate, customer, status, concern" })] }), filteredRepairOrders.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No repair orders saved yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: filteredRepairOrders.map((row) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: () => setSelectedRoId(row.id), style: {
                                        ...styles.mobileDataCardButton,
                                        ...(selectedRoId === row.id ? styles.mobileDataCardButtonActive : {}),
                                    }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.roNumber }), (0, jsx_runtime_1.jsx)(ROStatusBadge, { status: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataPrimary, children: row.plateNumber || row.conductionNumber || "-" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.accountLabel }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: [row.make, row.model, row.year].filter(Boolean).join(" ") || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Source" }), (0, jsx_runtime_1.jsx)("strong", { children: row.sourceType })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Estimate" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(row.workLines.reduce((sum, line) => sum + parseMoneyInput(line.totalEstimate), 0)) })] }), row.status === "Ready Release" ? ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.statusOk, marginTop: 4, fontSize: 11, padding: "2px 6px" }, children: "Ready for Release" })) : null, row.workLines.some((l) => l.status === "Waiting Parts") ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.statusWarning, marginTop: 4, fontSize: 11, padding: "2px 6px" }, children: ["Waiting Parts (", row.workLines.filter((l) => l.status === "Waiting Parts").length, ")"] })) : null] }, row.id))) })), selectedRO ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.detailPanel, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.cardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.cardTitle, children: selectedRO.roNumber }), (0, jsx_runtime_1.jsx)("div", { style: styles.cardSubtitle, children: "Linked intake is optional. Inspection is optional." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => printTextDocument(`Repair Order ${selectedRO.roNumber}`, buildRepairOrderExportText(selectedRO, users)), children: "Print RO" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => printCustomerSummary(selectedRO), children: "Print Summary" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => downloadTextFile(`${selectedRO.roNumber}_repair_order.txt`, buildRepairOrderExportText(selectedRO, users)), children: "Export RO" }), (0, jsx_runtime_1.jsx)(ROStatusBadge, { status: selectedRO.status })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryPanel, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.summaryGrid, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Account:" }), " ", selectedRO.accountLabel] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Plate:" }), " ", selectedRO.plateNumber || "-"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Conduction:" }), " ", selectedRO.conductionNumber || "-"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Vehicle:" }), " ", [selectedRO.make, selectedRO.model, selectedRO.year].filter(Boolean).join(" ") || "-"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Intake No.:" }), " ", selectedRO.intakeNumber || "Manual"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Inspection No.:" }), " ", selectedRO.inspectionNumber || "None"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Total Estimate:" }), " ", formatCurrency(selectedROEstimateTotal)] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Approved Lines:" }), " ", selectedROApprovedCount] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Pending Lines:" }), " ", selectedROPendingCount] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Primary Tech:" }), " ", selectedRO.primaryTechnicianId ? users.find((user) => user.id === selectedRO.primaryTechnicianId)?.fullName || "Assigned" : "Unassigned"] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.concernBanner, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Concern:" }), " ", selectedRO.customerConcern] })] }), selectedRO.status === "Ready Release" ? ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.statusOk, marginBottom: 8 }, children: "This RO is ready for release. Proceed to the Release module to complete the handover." })) : null, selectedRO.workLines.some((l) => l.status === "Waiting Parts") ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.statusWarning, marginBottom: 8 }, children: ["Waiting Parts  -  ", selectedRO.workLines.filter((l) => l.status === "Waiting Parts").map((l) => l.title || "Untitled").join(", ")] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "RO Status" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: selectedRO.status, onChange: (e) => handleROStatusChange(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "Draft", children: "Draft" }), (0, jsx_runtime_1.jsx)("option", { value: "Waiting Inspection", children: "Waiting Inspection" }), (0, jsx_runtime_1.jsx)("option", { value: "Waiting Approval", children: "Waiting Approval" }), (0, jsx_runtime_1.jsx)("option", { value: "Approved / Ready to Work", disabled: !canAdvanceToWork && selectedRO.status !== "Approved / Ready to Work", children: "Approved / Ready to Work" }), (0, jsx_runtime_1.jsx)("option", { value: "In Progress", disabled: !canAdvanceToWork && selectedRO.status !== "In Progress", children: "In Progress" }), (0, jsx_runtime_1.jsx)("option", { value: "Waiting Parts", disabled: !canAdvanceToWork && selectedRO.status !== "Waiting Parts", children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("option", { value: "Quality Check", disabled: !canAdvanceToWork && selectedRO.status !== "Quality Check", children: "Quality Check" }), (0, jsx_runtime_1.jsx)("option", { value: "Ready Release", disabled: !canAdvanceToWork && selectedRO.status !== "Ready Release", children: "Ready Release" }), (0, jsx_runtime_1.jsx)("option", { value: "Released", disabled: !canAdvanceToWork && selectedRO.status !== "Released", children: "Released" }), (0, jsx_runtime_1.jsx)("option", { value: "Closed", disabled: !canAdvanceToWork && selectedRO.status !== "Closed", children: "Closed" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Primary Technician" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: selectedRO.primaryTechnicianId, onChange: (e) => updateRO(selectedRO.id, { primaryTechnicianId: e.target.value }), children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Unassigned" }), primaryTechnicians.map((user) => ((0, jsx_runtime_1.jsxs)("option", { value: user.id, children: [user.fullName, "  |  ", user.role] }, user.id)))] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Odometer KM" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: selectedRO.odometerKm, onChange: (e) => updateRO(selectedRO.id, { odometerKm: e.target.value }), placeholder: "Current mileage" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryGrid, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Primary Tech:" }), " ", selectedRO.primaryTechnicianId ? getUserLabel(selectedRO.primaryTechnicianId) : "Unassigned"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Support:" }), " ", selectedRO.supportTechnicianIds.length ? selectedRO.supportTechnicianIds.map(getUserLabel).join(", ") : "None"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Total Estimate:" }), " ", formatCurrency(selectedROTotal)] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Updated:" }), " ", formatDateTime(selectedRO.updatedAt)] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Odometer:" }), " ", selectedRO.odometerKm || "-"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Approval Lock:" }), " ", canAdvanceToWork ? "Ready to advance" : "Blocked until all decisions are complete"] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Approved Line Total:" }), " ", formatCurrency(approvedEstimateTotal)] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.sectionTitle, children: ["Maintenance Suggestions ", selectedRO.odometerKm.trim() ? `(${selectedRO.odometerKm.trim()} km)` : '(KM pending)'] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Unified mileage + library matches. The best vehicle-specific version wins when a service appears in both sources." })] }), (0, jsx_runtime_1.jsxs)("span", { style: selectedROMaintenanceSuggestions.length ? styles.statusInfo : styles.statusNeutral, children: [selectedROMaintenanceSuggestions.length, " Visible"] })] }), selectedROMaintenanceSuggestionGroups.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No matching maintenance suggestions for this RO vehicle profile." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: selectedROMaintenanceSuggestionGroups.map((group) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.concernCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: group.category }), (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [group.items.length, " suggestions"] })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: group.items.map((item) => {
                                                                const titleKey = item.title.trim().toLowerCase();
                                                                ...
                                                                return ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: item.title }), (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: item.intervalTag })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.chipWrap, children: (0, jsx_runtime_1.jsx)("span", { style: styles.tagNeutral, children: item.specificityTag || "General" }) }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: item.reason }), item.isConditional ? (0, jsx_runtime_1.jsx)("div", { style: { ...styles.statusWarning, marginTop: 6 }, children: "If applicable" }) : null, (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.inlineActions, marginTop: 8 }, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, disabled: existsInRecommendations, onClick: () => addRoSuggestionToRecommendations(selectedRO.id, item), children: "Add to Recommendations" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, disabled: existsInWorkLines, onClick: () => addRoSuggestionToWorkLine(selectedRO.id, item), children: "Add to Work Line" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => dismissMileageSuggestion(`ro:${selectedRO.id}`, item.id), children: "Dismiss" })] })] }, item.id));
                                                            }) })] }, group.category))) })), (roRecommendationTitlesById[selectedRO.id] ?? []).length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Recommendations" }), (0, jsx_runtime_1.jsx)("div", { style: styles.chipWrap, children: (roRecommendationTitlesById[selectedRO.id] ?? []).map((title) => ((0, jsx_runtime_1.jsx)("span", { style: styles.tagNeutral, children: title }, title))) })] })) : null] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Added Maintenance Recommendations" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Selected items from the unified suggestion list appear here as the recommendation set for this RO." })] }), (0, jsx_runtime_1.jsxs)("span", { style: selectedROMaintenanceRecommendations.length ? styles.statusOk : styles.statusNeutral, children: [selectedROMaintenanceRecommendations.length, " Added"] })] }), selectedROMaintenanceRecommendations.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No maintenance recommendations added yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.chipWrap, children: selectedROMaintenanceRecommendations.map((title) => ((0, jsx_runtime_1.jsx)("span", { style: styles.tagNeutral, children: title }, title))) }))] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Customer Approval Layer" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Advisor view for internal control, plus a customer-friendly approval preview inspired by digital estimate workflows." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: approvalPreviewMode === "Advisor" ? styles.smallButton : styles.smallButtonMuted, onClick: () => setApprovalPreviewMode("Advisor"), children: "Advisor View" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: approvalPreviewMode === "Customer" ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: () => setApprovalPreviewMode("Customer"), children: "Customer View" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Approval Summary" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: approvalSummary, onChange: (e) => setApprovalSummary(e.target.value), placeholder: "Customer-friendly approval summary / estimate notes" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Communication Hook" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: approvalCommHook, onChange: (e) => setApprovalCommHook(e.target.value), placeholder: "SMS / email placeholder" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Use this as the delivery method label for SMS, email, Viber, or WhatsApp." })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "SMS Provider Settings" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Choose a provider and store gateway credentials locally for the demo send flow." })] }), (0, jsx_runtime_1.jsx)("span", { style: smsProviderConfig.isConfigured ? styles.statusOk : styles.statusWarning, children: smsProviderConfig.provider })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Provider Mode" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: smsProviderMode, onChange: (e) => setSmsProviderMode(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "simulated", children: "Simulated" }), (0, jsx_runtime_1.jsx)("option", { value: "android", children: "Android SMS Gateway" }), (0, jsx_runtime_1.jsx)("option", { value: "twilio", children: "Twilio" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Provider State" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.concernCard, children: [smsProviderConfig.provider, " ", smsProviderConfig.isConfigured ? `(${smsProviderConfig.endpointLabel})` : "(not configured)"] })] })] }), smsProviderMode === "android" ? ((0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Gateway URL" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: smsAndroidGatewayUrl, onChange: (e) => setSmsAndroidGatewayUrl(e.target.value), placeholder: "https://gateway.example.com/send" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "API Key / Auth Token" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: smsAndroidGatewayApiKey, onChange: (e) => setSmsAndroidGatewayApiKey(e.target.value), placeholder: "Optional auth token" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Sender Device Label" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: smsAndroidSenderDeviceLabel, onChange: (e) => setSmsAndroidSenderDeviceLabel(e.target.value), placeholder: "Front Desk Android" })] })] })) : smsProviderMode === "twilio" ? ((0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Account SID" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: smsTwilioAccountSid, onChange: (e) => setSmsTwilioAccountSid(e.target.value), placeholder: "ACxxxxxxxxxxxxxxxxxxxxxxxxxxxx" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "From Number" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: smsTwilioFromNumber, onChange: (e) => setSmsTwilioFromNumber(e.target.value), placeholder: "+63..." })] })] })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Simulated mode keeps the send flow local while the provider integration is being prepared." })), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, disabled: isSavingSmsProviderSettings, onClick: saveSmsProviderSettings, children: "Save Gateway Settings" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => {
                                                                        ...
                                                                        }, children: "Use Simulated" })] }), smsProviderConfigFeedback ? (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: smsProviderConfigFeedback }) : null] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "SMS Approval Link System" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Generate a secure customer portal link for this RO. Password login still works, but this link enables one-tap access from text." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, disabled: isGeneratingApprovalLink, onClick: () => {
                                                                        ...
                                                                        }, children: activeApprovalLinkToken ? "Regenerate Customer Link" : "Generate Customer Link" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => onOpenDemoCustomerApprovalLink(selectedRO), children: "Open Demo Approval View" })] })] }), autoPortalMessage ? (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: autoPortalMessage }) : null, (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: approvalLinkTokens.filter((row) => row.roId === selectedRO.id).slice(0, 3).map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("strong", { children: [row.channel, " Link"] }), (0, jsx_runtime_1.jsx)("span", { style: row.revokedAt ? styles.statusLocked : isApprovalLinkActive(row) ? styles.statusOk : styles.statusWarning, children: row.revokedAt ? "Revoked" : isApprovalLinkActive(row) ? "Active" : "Expired" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["URL: ", buildCustomerApprovalLinkUrl(row.token)] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Expires: ", formatDateTime(row.expiresAt), "  |  Last opened: ", row.lastUsedAt ? formatDateTime(row.lastUsedAt) : "Not yet used"] }), !row.revokedAt ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: async () => {
                                                                                try {
                                                                            ...
                                                                            }, children: "Copy Link" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => onRevokeApprovalLink(row.id), children: "Revoke Link" })] })) : null] }, row.id))) })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Due Service Reminders" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Simple reminder queue with live status and last sent time pulled from the SMS log." })] }), (0, jsx_runtime_1.jsxs)("span", { style: serviceReminderRows.some((row) => row.status !== "Sent") ? styles.statusWarning : styles.statusOk, children: [serviceReminderRows.length, " Visible"] })] }), serviceReminderRows.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No due or recently sent service reminders were found for this repair order." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: serviceReminderRows.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.title }), (0, jsx_runtime_1.jsx)("span", { style: row.status === "Sent" ? styles.statusOk : row.status === "Overdue" ? styles.statusWarning : styles.statusInfo, children: row.status })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: ["RO: ", row.roNumber, "  |  ", row.vehicleLabel] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.customerName }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Due" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(row.dueDate) })] }), row.lastSentAt ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Last sent" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(row.lastSentAt) })] })) : null, (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: row.dueReason }), (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: async () => {
                                                                            try {
                                                                        ...
                                                                        }, children: "Copy Message" }) })] }, row.key))) }))] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Oil Change Reminders" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Latest valid oil change per vehicle. Conventional: 6 months or 5,000 km. Fully synthetic: 12 months or 10,000 km." })] }), (0, jsx_runtime_1.jsxs)("span", { style: oilChangeReminders.some((row) => row.isDue) ? styles.statusWarning : styles.statusOk, children: [oilChangeReminders.filter((row) => row.isDue).length, " Due"] })] }), oilChangeReminders.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No oil change service records were found for this workshop history yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: oilChangeReminders.map((reminder) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: reminder.vehicleLabel }), (0, jsx_runtime_1.jsx)("span", { style: reminder.isDue ? styles.statusWarning : styles.statusOk, children: reminder.isDue ? "Due" : "Not Due Yet" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: reminder.plateNumber || reminder.conductionNumber || "-" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: ["Customer: ", reminder.customerName] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Last oil change" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(reminder.serviceDate) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Service odometer" }), (0, jsx_runtime_1.jsx)("strong", { children: reminder.serviceOdometerKm || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Current odometer" }), (0, jsx_runtime_1.jsx)("strong", { children: reminder.currentOdometerKm || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Due threshold" }), (0, jsx_runtime_1.jsx)("strong", { children: reminder.oilType === "Fully Synthetic" ? "12 months / 10,000 km" : "6 months / 5,000 km" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: reminder.dueReason }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => {
                                                                                setNotificationTemplateKey("oil-reminder");
                                                                                setSelectedOilReminderVehicleKey(reminder.vehicleKey);
                                                                            }, children: "View Template" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: async () => {
                                                                                try {
                                                                            ...
                                                                            }, children: "Copy Reminder" })] })] }, reminder.vehicleKey))) }))] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Release Follow-Up Reminders" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Triggers 3 days after release if the RO is still released and no newer job has been opened for the same vehicle." })] }), (0, jsx_runtime_1.jsxs)("span", { style: releaseFollowUpReminders.some((row) => row.isDue) ? styles.statusWarning : styles.statusOk, children: [releaseFollowUpReminders.filter((row) => row.isDue).length, " Due"] })] }), releaseFollowUpReminders.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No post-release follow-ups are due yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: releaseFollowUpReminders.map((reminder) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Follow-up (3 days after release)" }), (0, jsx_runtime_1.jsx)("span", { style: reminder.isDue ? styles.statusWarning : styles.statusOk, children: reminder.isDue ? "Due" : "Not Due Yet" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: ["RO: ", reminder.roNumber, "  |  Release: ", reminder.releaseNumber] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [reminder.vehicleLabel, " ", reminder.plateNumber || reminder.conductionNumber ? `(${reminder.plateNumber || reminder.conductionNumber})` : ""] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Released" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(reminder.releaseDate) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Follow-up due" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(reminder.dueDate) })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: reminder.dueReason }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => {
                                                                                setNotificationTemplateKey("follow-up");
                                                                                setSelectedFollowUpVehicleKey(reminder.vehicleKey);
                                                                            }, children: "View Template" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: reminder.isDue ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: async () => {
                                                                                if (!reminder.isDue)
                                                                                    return;
                                                                                try {
                                                                            ...
                                                                            }, children: "Copy Message" })] })] }, reminder.vehicleKey))) }))] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Customer Notification Templates" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Preview and copy SMS-ready text generated from the live RO, inspection, parts, release, and pull-out records." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: notificationTemplateKey === "approval-request" ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: () => setNotificationTemplateKey("approval-request"), children: "Approval Request" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: notificationTemplateKey === "waiting-parts" ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: () => setNotificationTemplateKey("waiting-parts"), children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: notificationTemplateKey === "ready-release" ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: () => setNotificationTemplateKey("ready-release"), children: "Ready Release" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: notificationTemplateKey === "pull-out-notice" ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: () => setNotificationTemplateKey("pull-out-notice"), children: "Pull-Out Notice" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: notificationTemplateKey === "oil-reminder" ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: () => setNotificationTemplateKey("oil-reminder"), children: "Oil Reminder" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: notificationTemplateKey === "follow-up" ? styles.smallButtonSuccess : styles.smallButtonMuted, onClick: () => setNotificationTemplateKey("follow-up"), children: "Follow-Up" })] })] }), activeCustomerNotificationTemplate ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: activeCustomerNotificationTemplate.subtitle }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryGrid, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Template:" }), " ", activeCustomerNotificationTemplate.title] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "RO:" }), " ", notificationPreviewRoNumber] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Vehicle:" }), " ", notificationPreviewVehicleLabel] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Customer:" }), " ", notificationPreviewCustomerName] })] }), (0, jsx_runtime_1.jsx)("textarea", { style: { ...styles.textarea, minHeight: 260, fontFamily: "monospace" }, readOnly: true, value: activeCustomerNotificationTemplate.body }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: async () => {
                                                                            try {
                                                                        ...
                                                                        }, children: "Copy Template" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: activeCustomerNotificationTemplateSendable ? styles.smallButtonSuccess : styles.smallButtonMuted, disabled: !activeCustomerNotificationTemplateSendable || sendingSmsKey === activeCustomerNotificationTemplate.key, onClick: async () => {
                                                                        ...
                                                                        }, children: sendingSmsKey === activeCustomerNotificationTemplate.key ? "Sending..." : "Send SMS" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["SMS provider: ", smsProviderConfig.provider, " ", smsProviderConfig.isConfigured
                                                                        ...
                                                                        : smsProviderConfig.provider === "Android SMS Gateway" && !smsProviderConfig.isConfigured
                                                                            ...
                                                                            : " Ready to send from the current live record."] }), smsSendFeedback ? (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: smsSendFeedback }) : null] })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "Select a repair order to preview customer notification templates." }))] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "SMS Attempt Log" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Pending, sent, and failed attempts are stored locally so the send flow can be verified without a backend." })] }), (0, jsx_runtime_1.jsxs)("span", { style: recentSmsAttempts.some((row) => (row.status ?? "Sent") === "Failed") ? styles.statusWarning : styles.statusOk, children: [recentSmsAttempts.length, " Recent"] })] }), recentSmsAttempts.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No SMS attempts have been logged for this repair order yet." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: recentSmsAttempts.map((row) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.messageType }), (0, jsx_runtime_1.jsx)("span", { style: row.status === "Failed" ? styles.statusWarning : row.status === "Pending" ? styles.statusNeutral : styles.statusOk, children: row.status ?? "Sent" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.customerName || selectedRO.accountLabel }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Phone" }), (0, jsx_runtime_1.jsx)("strong", { children: row.phoneNumber || row.sentTo || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Provider" }), (0, jsx_runtime_1.jsx)("strong", { children: row.provider || "Simulated" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: row.status === "Sent" ? "Last sent" : "Attempted" }), (0, jsx_runtime_1.jsx)("strong", { children: formatDateTime(row.createdAt) })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: row.message }), row.providerResponse ? (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Provider response: ", row.providerResponse] }) : null, row.errorMessage ? (0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: row.errorMessage }) : null, row.status === "Failed" ? ((0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, disabled: resendingSmsLogId === row.id, onClick: async () => {
                                                                        ...
                                                                        }, children: resendingSmsLogId === row.id ? "Resending..." : "Resend" }) })) : null] }, row.id))) }))] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.summaryGrid, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Approved" }), (0, jsx_runtime_1.jsx)("div", { children: totalApprovedCount })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Declined" }), (0, jsx_runtime_1.jsx)("div", { children: totalDeclinedCount })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Deferred" }), (0, jsx_runtime_1.jsx)("div", { children: totalDeferredCount })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Pending" }), (0, jsx_runtime_1.jsx)("div", { children: approvalPendingCount })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Approved Total" }), (0, jsx_runtime_1.jsx)("div", { children: formatCurrency(approvedEstimateTotal) })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Pending Total" }), (0, jsx_runtime_1.jsx)("div", { children: formatCurrency(pendingEstimateTotal) })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Deferred Total" }), (0, jsx_runtime_1.jsx)("div", { children: formatCurrency(deferredEstimateTotal) })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Declined Total" }), (0, jsx_runtime_1.jsx)("div", { children: formatCurrency(declinedEstimateTotal) })] })] }), (approvedWorkLines.length > 0 || declinedWorkLines.length > 0 || deferredWorkLines.length > 0) ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Approval Summary" }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.summaryGrid, marginBottom: 10 }, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { style: { color: "#15803d" }, children: "Approved" }), (0, jsx_runtime_1.jsxs)("div", { children: [approvedWorkLines.length, " line", approvedWorkLines.length !== 1 ? "s" : "", "  |  ", formatCurrency(approvedEstimateTotal)] })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { style: { color: "#b45309" }, children: "Deferred" }), (0, jsx_runtime_1.jsxs)("div", { children: [deferredWorkLines.length, " line", deferredWorkLines.length !== 1 ? "s" : "", "  |  ", formatCurrency(deferredEstimateTotal)] })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { style: { color: "#b91c1c" }, children: "Declined" }), (0, jsx_runtime_1.jsxs)("div", { children: [declinedWorkLines.length, " line", declinedWorkLines.length !== 1 ? "s" : "", "  |  ", formatCurrency(declinedEstimateTotal)] })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Pending" }), (0, jsx_runtime_1.jsxs)("div", { children: [pendingWorkLines.length, " line", pendingWorkLines.length !== 1 ? "s" : "", "  |  ", formatCurrency(pendingEstimateTotal)] })] })] }), approvedWorkLines.length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: 10 }, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.formHint, fontWeight: 600, color: "#15803d", marginBottom: 4 }, children: "Approved Work Lines" }), approvedWorkLines.map((line) => ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.mobileDataCard, borderLeft: "3px solid #15803d", marginBottom: 4 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.title || "Untitled" }), (0, jsx_runtime_1.jsx)("span", { children: formatCurrency(parseMoneyInput(line.totalEstimate)) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category || "General", "  |  ", line.priority, " priority  |  ", line.status] })] }, `sum_approved_${line.id}`)))] })) : null, deferredWorkLines.length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: 10 }, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.formHint, fontWeight: 600, color: "#b45309", marginBottom: 4 }, children: "Deferred Items" }), deferredWorkLines.map((line) => ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.mobileDataCard, borderLeft: "3px solid #b45309", marginBottom: 4 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.title || "Untitled" }), (0, jsx_runtime_1.jsx)("span", { children: formatCurrency(parseMoneyInput(line.totalEstimate)) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category || "General", "  |  ", line.priority, " priority"] }), line.notes ? (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: line.notes }) : null] }, `sum_deferred_${line.id}`)))] })) : null, declinedWorkLines.length > 0 ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.formHint, fontWeight: 600, color: "#b91c1c", marginBottom: 4 }, children: "Declined Items" }), declinedWorkLines.map((line) => ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.mobileDataCard, borderLeft: "3px solid #b91c1c", marginBottom: 4 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.title || "Untitled" }), (0, jsx_runtime_1.jsx)("span", { children: formatCurrency(parseMoneyInput(line.totalEstimate)) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category || "General", "  |  ", line.priority, " priority"] }), line.notes ? (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: line.notes }) : null] }, `sum_declined_${line.id}`)))] })) : null] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.inlineActions, marginTop: 12, flexWrap: "wrap" }, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => setBulkLineDecision("Approved"), disabled: pendingWorkLines.length === 0, children: "Approve All Pending Lines" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => setBulkLineDecision("Deferred"), disabled: pendingWorkLines.length === 0, children: "Defer All Pending Lines" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => setBulkLineDecision("Declined"), disabled: pendingWorkLines.length === 0, children: "Decline All Pending Lines" })] }), !canAdvanceToWork ? ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.errorBox, marginTop: 12 }, children: "RO progression is locked. Decide all pending work lines and findings before moving this job into work. At least one work line must be approved." })) : ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.statusOk, marginTop: 12 }, children: "Approval complete. This RO can now move into work." })), findingRecommendations.length ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Inspection Findings Waiting for RO Mapping" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Approving a finding inserts a new RO work line immediately. Declined findings stay out of the RO. Deferred findings stay visible for follow-up." })] }), (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [findingRecommendations.length, " finding recommendations"] })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.inlineActions, marginTop: 12, flexWrap: "wrap" }, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => setBulkFindingRecommendationDecision("Approved"), disabled: pendingFindingRecommendations.length === 0, children: "Approve All Pending Findings" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => setBulkFindingRecommendationDecision("Deferred"), disabled: pendingFindingRecommendations.length === 0, children: "Defer All Pending Findings" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => setBulkFindingRecommendationDecision("Declined"), disabled: pendingFindingRecommendations.length === 0, children: "Decline All Pending Findings" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: findingRecommendations.map((item) => ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.mobileDataCard, border: "1px solid rgba(59, 130, 246, 0.16)" }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: item.workLineTitle }), (0, jsx_runtime_1.jsx)("span", { style: getApprovalDecisionStyle(toApprovalDecision(item.decision)), children: item.decision })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [item.category, "  |  Source finding: ", item.title] }), item.note ? (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: item.note }) : null, item.photoNotes.length ? (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Photo notes: ", item.photoNotes.join("  |  ")] }) : null, item.decidedAt ? (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Decision Time: ", formatDateTime(item.decidedAt)] }) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => setFindingRecommendationDecision(item, "Approved"), disabled: item.decision === "Approved", children: "Approve to RO" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => setFindingRecommendationDecision(item, "Deferred"), disabled: item.decision === "Deferred", children: "Defer" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => setFindingRecommendationDecision(item, "Declined"), disabled: item.decision === "Declined", children: "Decline" })] }), item.decision === "Approved" ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "This finding is already mapped into the RO work lines." })) : null] }, `finding_map_${item.id}`))) })] })) : null, approvalPreviewMode === "Customer" ? ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCardMuted, marginTop: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Customer-Friendly Approval Preview" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: selectedRO.workLines.map((line) => {
                                                            const decision = line.approvalDecision ??
                                                                selectedApproval?.items.find((item) => item.workLineId === line.id)?.decision ??
                                                                "Pending";
                                                            return ((0, jsx_runtime_1.jsxs)("div", { style: { ...styles.mobileDataCard, border: "1px solid rgba(37, 99, 235, 0.12)", background: "#ffffff" }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.title || "Untitled Work Line" }), (0, jsx_runtime_1.jsx)("span", { style: getApprovalDecisionStyle(decision), children: decision })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category || "General", "  |  ", formatCurrency(parseMoneyInput(line.totalEstimate))] }), (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: getCustomerFriendlyLineDescription(line) }), line.notes ? (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Tech notes: ", line.notes] }) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => setLineDecision("Approved", line.id), children: "Approve Work" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => setLineDecision("Deferred", line.id), children: "Decide Later" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => setLineDecision("Declined", line.id), children: "Decline Work" })] })] }, `customer_approval_${line.id}`));
                                                        }) }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Message Preview" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textareaLarge, value: customerApprovalMessage, readOnly: true })] })] })) : ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.mobileCardList, marginTop: 12 }, children: selectedRO.workLines.map((line) => {
                                                    const decision = line.approvalDecision ??
                                                        selectedApproval?.items.find((item) => item.workLineId === line.id)?.decision ??
                                                        "Pending";
                                                    const approvedAt = line.approvalAt ||
                                                        ...
                                                        "";
                                                    return ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.title || "Untitled Work Line" }), (0, jsx_runtime_1.jsx)("span", { style: getApprovalDecisionStyle(decision), children: decision })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category || "General", "  |  ", formatCurrency(parseMoneyInput(line.totalEstimate))] }), line.recommendationSource ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Source: ", line.recommendationSource] })) : null, approvedAt ? (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Decision Time: ", formatDateTime(approvedAt)] }) : null, line.notes ? (0, jsx_runtime_1.jsx)("div", { style: styles.concernCard, children: line.notes }) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => setLineDecision("Approved", line.id), children: "Approve Work" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => setLineDecision("Deferred", line.id), children: "Decide Later" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => setLineDecision("Declined", line.id), children: "Decline Work" })] })] }, `approval_${line.id}`));
                                                }) })), selectedApproval ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Last approval record: ", selectedApproval.approvalNumber, "  |  ", formatDateTime(selectedApproval.createdAt), "  |  Deferred: ", selectedRO.deferredLineTitles.length ? selectedRO.deferredLineTitles.join(", ") : "None", "  |  Hook: ", selectedApproval.communicationHook] })) : null] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Backjob / Comeback Tracking" }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Complaint" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: backjobComplaint, onChange: (e) => setBackjobComplaint(e.target.value), placeholder: "Describe comeback issue" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Root Cause" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: backjobRootCause, onChange: (e) => setBackjobRootCause(e.target.value), placeholder: "Root cause / source" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid2, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Responsibility" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: backjobOutcome, onChange: (e) => setBackjobOutcome(e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "Customer Pay", children: "Customer Pay" }), (0, jsx_runtime_1.jsx)("option", { value: "Internal", children: "Internal" }), (0, jsx_runtime_1.jsx)("option", { value: "Warranty", children: "Warranty" }), (0, jsx_runtime_1.jsx)("option", { value: "Goodwill", children: "Goodwill" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Resolution Notes" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: backjobResolutionNotes, onChange: (e) => setBackjobResolutionNotes(e.target.value), placeholder: "Action taken / resolution" })] })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: createBackjob, children: "Save Backjob Record" }) }), selectedBackjobs.length ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: selectedBackjobs.slice(0, 3).map((item) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: item.backjobNumber }), (0, jsx_runtime_1.jsx)("span", { style: styles.statusWarning, children: item.responsibility })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: item.complaint }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: item.rootCause || "No root cause entered" })] }, item.id))) })) : null] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Work Lines" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.secondaryButton, onClick: () => addROWorkLine(selectedRO.id), children: "Add Work Line" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formStack, children: selectedRO.workLines.map((line, index) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCardMuted, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("strong", { children: ["Line ", index + 1] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("span", { style: getApprovalDecisionStyle(line.approvalDecision ?? "Pending"), children: line.approvalDecision ?? "Pending" }), (0, jsx_runtime_1.jsx)(WorkLineStatusBadge, { status: line.status }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => removeROWorkLine(selectedRO.id, line.id), disabled: line.approvalDecision === "Approved", children: "Remove" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Title" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.title, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "title", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Category" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.category, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "category", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Priority" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: line.priority, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "priority", e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "Low", children: "Low" }), (0, jsx_runtime_1.jsx)("option", { value: "Medium", children: "Medium" }), (0, jsx_runtime_1.jsx)("option", { value: "High", children: "High" })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Status" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: line.status, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "status", e.target.value), disabled: (line.approvalDecision ?? "Pending") !== "Approved", children: [(0, jsx_runtime_1.jsx)("option", { value: "Pending", children: "Pending" }), (0, jsx_runtime_1.jsx)("option", { value: "In Progress", children: "In Progress" }), (0, jsx_runtime_1.jsx)("option", { value: "Waiting Parts", children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("option", { value: "Completed", children: "Completed" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid3, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Service Estimate" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.serviceEstimate, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "serviceEstimate", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Parts Estimate" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.partsEstimate, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "partsEstimate", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Total" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: formatCurrency(parseMoneyInput(line.totalEstimate)), readOnly: true })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Notes" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: line.notes, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "notes", e.target.value) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Customer Description" }), (0, jsx_runtime_1.jsx)("textarea", { style: styles.textarea, value: line.customerDescription, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "customerDescription", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.formStack : styles.formGrid4, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Labor Hours" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.laborHours, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "laborHours", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Labor Rate" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.laborRate, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "laborRate", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Parts Cost" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.partsCost, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "partsCost", e.target.value), disabled: line.approvalDecision === "Approved" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Markup %" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: line.partsMarkupPercent, onChange: (e) => updateROWorkLine(selectedRO.id, line.id, "partsMarkupPercent", e.target.value), disabled: line.approvalDecision === "Approved" })] })] }), line.recommendationSource ? (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Source: ", line.recommendationSource] }) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Labor: ", formatCurrency(getWorkLinePricing(line).laborAmount), "  |  Parts: ", formatCurrency(getWorkLinePricing(line).partsAmount), "  |  Total: ", formatCurrency(getWorkLinePricing(line).totalAmount)] }), (line.approvalDecision ?? "Pending") !== "Approved" ? ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Execution status is locked until this line is approved." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Approved lines are locked for pricing/title edits and ready for execution tracking." }))] })] }, line.id))) })] })] })) : null] }) })] }) }));
}
function UsersPage({ currentUser, users, setUsers, roleDefinitions, isCompactLayout, }) {
    ...
    const [error, setError] = (0, react_1.useState)("");
    const [isCreatingUser, setIsCreatingUser] = (0, react_1.useState)(false);
    const resetForm = () => {
        setForm({
            fullName: "",
            username: "",
...
function ShopFloorPage({ currentUser, users, repairOrders, setRepairOrders, workLogs, setWorkLogs, isCompactLayout, }) {
    const [search, setSearch] = (0, react_1.useState)("");
    const [viewMode, setViewMode] = (0, react_1.useState)(["General Mechanic", "OJT"].includes(currentUser.role) ? "My Jobs" : "All Jobs");
    const [selectedRoId, setSelectedRoId] = (0, react_1.useState)("");
    ...
    const supportTechnicians = (0, react_1.useMemo)(() => users.filter((user) => user.active &&
        ["Chief Technician", "Senior Mechanic", "General Mechanic", "OJT"].includes(user.role)), [users]);
    const sortedRepairOrders = (0, react_1.useMemo)(() => [...repairOrders].sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()), [repairOrders]);
    const visibleRepairOrders = (0, react_1.useMemo)(() => {
    ...
    const selectedRO = (0, react_1.useMemo)(() => visibleRepairOrders.find((row) => row.id === selectedRoId) ?? visibleRepairOrders[0] ?? null, [selectedRoId, visibleRepairOrders]);
    (0, react_1.useEffect)(() => {
    ...
    const roWorkLogs = (0, react_1.useMemo)(() => workLogs.filter((row) => row.roId === selectedRO?.id), [selectedRO?.id, workLogs]);
    const activeRoWorkLogs = (0, react_1.useMemo)(() => roWorkLogs.filter((row) => !row.endedAt), [roWorkLogs]);
    ...
    const lineMinutesMap = (0, react_1.useMemo)(() => {
        const map = new Map();
    ...
    const techMinutesMap = (0, react_1.useMemo)(() => {
        const map = new Map();
        roWorkLogs.forEach((log) => {
    ...
    const selectedROCompletedLines = selectedRO
        ...
        : 0;
    const technicianBoard = (0, react_1.useMemo)(() => {
    ...
    const myLiveLogs = (0, react_1.useMemo)(() => workLogs.filter((log) => log.technicianId === currentUser.id && !log.endedAt), [currentUser.id, workLogs]);
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Shop Floor Job Feed", subtitle: "Newest to oldest operational board with technician assignment, live timers, and no fixed bay layout", right: (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [visibleRepairOrders.length, " visible jobs"] }), (0, jsx_runtime_1.jsx)("span", { style: canManageShopFloor ? styles.statusOk : styles.statusNeutral, children: canManageShopFloor ? "Manage Allowed" : "View Only" })] }), children: (0, jsx_runtime_1.jsx)("div", { style: styles.heroText, children: "This board uses repair orders as the live job source. It does not use fixed bays. Jobs stay visible from draft through closed so management and staff can see the full queue, reassign technicians quickly, and move vehicles cleanly from approval to release." }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "All Jobs" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: statusCounts.total }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Full queue from RO records" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "In Progress" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: statusCounts.inProgress }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Vehicles actively worked on" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: statusCounts.waitingParts }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Paused for parts availability" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "QC / Ready Release" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: statusCounts.qc + statusCounts.readyRelease }), (0, jsx_runtime_1.jsx)("div", { style: styles.statNote, children: "Near-completion vehicles" })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(3, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.statCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.statLabel, children: "My Active Jobs" }), (0, jsx_runtime_1.jsx)("div", { style: styles.statValue, children: myActiveJobsCount }), (0, jsx_runtime_1.jsxs)("div", { style: styles.statNote, children: ["Jobs assigned to ", currentUser.fullName.split(" ")[0]] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Technician Board", subtitle: "Live workload, active timers, booked hours, and efficiency base for each technician", right: (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [technicianBoard.length, " technicians tracked"] }), children: technicianBoard.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No active technicians found." })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: technicianBoard.map(({ user, assignedJobs, liveLogs, bookedMinutes, completedJobs, laborProduced, efficiency }) => ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: user.fullName }), (0, jsx_runtime_1.jsx)(RoleBadge, { role: user.role })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Assigned Jobs" }), (0, jsx_runtime_1.jsx)("strong", { children: assignedJobs.length })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Live Timers" }), (0, jsx_runtime_1.jsx)("strong", { children: liveLogs.length })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Booked Time" }), (0, jsx_runtime_1.jsx)("strong", { children: formatMinutesAsHours(bookedMinutes) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Completed Jobs" }), (0, jsx_runtime_1.jsx)("strong", { children: completedJobs })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Labor Produced" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(laborProduced) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Efficiency" }), (0, jsx_runtime_1.jsxs)("strong", { children: [efficiency, "%"] })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: assignedJobs.length
                                            ? assignedJobs
                                                .slice(0, 3)
                                                .map((job) => `${job.roNumber}  |  ${job.status}`)
                                                .join("  |  ")
                                            : "No assigned jobs." })] }, user.id))) })) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(4, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Queue Controls", subtitle: "Filter the board and open any job", children: (0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Search Jobs" }), (0, jsx_runtime_1.jsx)("input", { style: styles.input, value: search, onChange: (e) => setSearch(e.target.value), placeholder: "RO number, plate, customer, concern" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                                ...styles.secondaryButton,
                                                ...(viewMode === "All Jobs" ? { borderColor: "#2563eb", color: "#2563eb" } : {}),
                                            }, onClick: () => setViewMode("All Jobs"), children: "All Jobs" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                                ...styles.secondaryButton,
                                                ...(viewMode === "My Jobs" ? { borderColor: "#2563eb", color: "#2563eb" } : {}),
                                            }, onClick: () => setViewMode("My Jobs"), children: "My Jobs" })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.queueStack, children: visibleRepairOrders.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No jobs match the current filter." })) : isCompactLayout ? ((0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: visibleRepairOrders.map((row) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", style: {
                                                ...styles.mobileDataCardButton,
                                                ...(selectedRO?.id === row.id ? styles.mobileDataCardButtonActive : {}),
                                            }, onClick: () => setSelectedRoId(row.id), children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.roNumber }), (0, jsx_runtime_1.jsx)("span", { style: getROStatusStyle(row.status), children: row.status })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [row.plateNumber || row.conductionNumber || "No plate yet", "  |  ", row.make, " ", row.model] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileDataSecondary, children: row.accountLabel }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Primary Tech" }), (0, jsx_runtime_1.jsx)("strong", { children: row.primaryTechnicianId ? getUserName(row.primaryTechnicianId) : "Unassigned" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Elapsed" }), (0, jsx_runtime_1.jsx)("strong", { children: formatElapsedTime(row.workStartedAt) })] })] }, row.id))) })) : (visibleRepairOrders.map((row) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", style: {
                                            ...styles.queueCard,
                                            ...(selectedRO?.id === row.id ? styles.queueCardActive : {}),
                                        }, onClick: () => setSelectedRoId(row.id), children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.queueCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: row.roNumber }), (0, jsx_runtime_1.jsx)("span", { style: getROStatusStyle(row.status), children: row.status })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.queueLine, children: row.plateNumber || row.conductionNumber || "No plate yet" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.queueLineMuted, children: [row.accountLabel, "  |  ", row.make, " ", row.model] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.queueLineMuted, children: ["Primary: ", row.primaryTechnicianId ? getUserName(row.primaryTechnicianId) : "Unassigned"] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.queueLineMuted, children: ["Elapsed: ", formatElapsedTime(row.workStartedAt)] })] }, row.id)))) })] }) }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(8, isCompactLayout) }, children: (0, jsx_runtime_1.jsx)(Card, { title: "Job Detail", subtitle: "Live status, technician assignment, and work summary", right: selectedRO ? (0, jsx_runtime_1.jsx)(ROStatusBadge, { status: selectedRO.status }) : undefined, children: !selectedRO ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No repair orders are available yet." })) : ((0, jsx_runtime_1.jsxs)("div", { style: styles.formStack, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.summaryPanel, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.summaryGrid, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "RO Number" }), (0, jsx_runtime_1.jsx)("div", { children: selectedRO.roNumber })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Vehicle" }), (0, jsx_runtime_1.jsxs)("div", { children: [selectedRO.make, " ", selectedRO.model, " ", selectedRO.year] })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Plate / Conduction" }), (0, jsx_runtime_1.jsx)("div", { children: selectedRO.plateNumber || selectedRO.conductionNumber || "-" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Customer" }), (0, jsx_runtime_1.jsx)("div", { children: selectedRO.accountLabel })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Created" }), (0, jsx_runtime_1.jsx)("div", { children: formatDateTime(selectedRO.createdAt) })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Elapsed" }), (0, jsx_runtime_1.jsx)("div", { children: formatElapsedTime(selectedRO.workStartedAt) })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Primary Tech" }), (0, jsx_runtime_1.jsx)("div", { children: selectedRO.primaryTechnicianId ? getUserName(selectedRO.primaryTechnicianId) : "Unassigned" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Support Team" }), (0, jsx_runtime_1.jsx)("div", { children: selectedRO.supportTechnicianIds.length ? selectedRO.supportTechnicianIds.map(getUserName).join(", ") : "None" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Completed Lines" }), (0, jsx_runtime_1.jsxs)("div", { children: [selectedROCompletedLines, " / ", selectedRO.workLines.length] })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Total Estimate" }), (0, jsx_runtime_1.jsx)("div", { children: formatCurrency(selectedROEstimateTotal) })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.concernBanner, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Concern:" }), " ", selectedRO.customerConcern || "No concern entered."] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.grid, children: [(0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(6, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Status" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Current RO Status" }), (0, jsx_runtime_1.jsx)("select", { style: styles.select, value: selectedRO.status, disabled: !canManageShopFloor, onChange: (e) => handleStatusChange(selectedRO.id, e.target.value), children: [
                                                                    "Draft",
                                                                    "Waiting Inspection",
                                                                    "Waiting Approval",
                                                                    "Approved / Ready to Work",
                                                                    ...
                                                                    "Released",
                                                                    "Closed",
                                                                ].map((status) => ((0, jsx_runtime_1.jsx)("option", { value: status, children: status }, status))) })] }), (0, jsx_runtime_1.jsxs)("div", { style: isCompactLayout ? styles.stickyActionBar : styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                                                    ...styles.primaryButton,
                                                                    ...(canManageShopFloor ? {} : styles.buttonDisabled),
                                                                }, disabled: !canManageShopFloor, onClick: () => handleStatusChange(selectedRO.id, "In Progress"), children: "Start Work" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                                                    ...styles.secondaryButton,
                                                                    ...(canManageShopFloor ? {} : styles.buttonDisabled),
                                                                }, disabled: !canManageShopFloor, onClick: () => handleStatusChange(selectedRO.id, "Waiting Parts"), children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                                                    ...styles.secondaryButton,
                                                                    ...(canManageShopFloor ? {} : styles.buttonDisabled),
                                                                }, disabled: !canManageShopFloor, onClick: () => handleStatusChange(selectedRO.id, "Quality Check"), children: "Send QC" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: {
                                                                    ...styles.secondaryButton,
                                                                    ...(canManageShopFloor ? {} : styles.buttonDisabled),
                                                                }, disabled: !canManageShopFloor, onClick: () => handleStatusChange(selectedRO.id, "Ready Release"), children: "Ready Release" })] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: getResponsiveSpan(6, isCompactLayout) }, children: (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Technicians" }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Primary Technician" }), (0, jsx_runtime_1.jsxs)("select", { style: styles.select, value: selectedRO.primaryTechnicianId, disabled: !canManageShopFloor, onChange: (e) => handlePrimaryChange(selectedRO.id, e.target.value), children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "Select primary technician" }), primaryTechnicians.map((user) => ((0, jsx_runtime_1.jsxs)("option", { value: user.id, children: [user.fullName, "  -  ", user.role] }, user.id)))] }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "OJT is excluded from primary technician assignment." })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.formGroup, children: [(0, jsx_runtime_1.jsx)("label", { style: styles.label, children: "Support Technicians" }), (0, jsx_runtime_1.jsx)("div", { style: styles.checkboxList, children: supportTechnicians.map((user) => ((0, jsx_runtime_1.jsxs)("label", { style: styles.checkboxRow, children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: selectedRO.supportTechnicianIds.includes(user.id), disabled: !canManageShopFloor || user.id === selectedRO.primaryTechnicianId, onChange: () => handleSupportToggle(selectedRO.id, user.id) }), (0, jsx_runtime_1.jsxs)("span", { children: [user.fullName, "  -  ", user.role] })] }, user.id))) })] })] }) })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.sectionCard, marginBottom: 12 }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Technician Work Logs" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Start and stop technician timers per work line. These logs feed the dashboard productivity view." })] }), (0, jsx_runtime_1.jsxs)("span", { style: styles.statusInfo, children: [roWorkLogs.length, " logs  |  ", activeRoWorkLogs.length, " live"] })] }), (0, jsx_runtime_1.jsx)("div", { style: { ...styles.mobileCardList, marginTop: 12 }, children: selectedRO.workLines.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { style: styles.emptyState, children: "No work lines available yet for technician logging." })) : (selectedRO.workLines.map((line) => {
                                                ...
                                                return ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.title || "Untitled Work Line" }), (0, jsx_runtime_1.jsx)("span", { style: getWorkLineStatusStyle(line.status), children: line.status })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category, "  |  Logged Time: ", formatMinutesAsHours(lineMinutesMap.get(line.id) ?? 0)] }), activeLineLogs.length ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Live: ", activeLineLogs.map((log) => `${getUserName(log.technicianId)} (${formatElapsedTime(log.startedAt)})`).join("  |  ")] })) : ((0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "No active timer on this work line." })), (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => startWorkLog(line.id, suggestedTechId), children: "Start Primary Timer" }), activeLineLogs
                                                                    .filter((log) => canManageShopFloor || log.technicianId === currentUser.id)
                                                                    .map((log) => ((0, jsx_runtime_1.jsxs)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => stopWorkLog(log.id), children: ["Stop ", getUserName(log.technicianId)] }, log.id)))] })] }, `techlog_${line.id}`));
                                            })) }), roWorkLogs.length ? ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.tableWrap, marginTop: 12 }, children: (0, jsx_runtime_1.jsxs)("table", { style: styles.table, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Technician" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Work Line" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Started" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Ended" }), (0, jsx_runtime_1.jsx)("th", { style: styles.th, children: "Hours" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: roWorkLogs.slice(0, 12).map((log) => {
                                                            const line = selectedRO.workLines.find((row) => row.id === log.workLineId);
                                                            return ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: styles.td, children: getUserName(log.technicianId) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: line?.title || "Work Line" }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatDateTime(log.startedAt) }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: log.endedAt ? formatDateTime(log.endedAt) : "Live" }), (0, jsx_runtime_1.jsx)("td", { style: styles.td, children: formatMinutesAsHours(getWorkLogMinutes(log)) })] }, log.id));
                                                        }) })] }) })) : null, Array.from(techMinutesMap.entries()).length ? ((0, jsx_runtime_1.jsx)("div", { style: { ...styles.inlineActions, marginTop: 12, flexWrap: "wrap" }, children: Array.from(techMinutesMap.entries()).map(([techId, minutes]) => ((0, jsx_runtime_1.jsxs)("span", { style: styles.statusNeutral, children: [getUserName(techId), "  |  ", formatMinutesAsHours(minutes)] }, techId))) })) : null] }), myLiveLogs.length ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "My Live Timers" }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "Quick stop controls for the signed-in technician." })] }), (0, jsx_runtime_1.jsxs)("span", { style: styles.statusWarning, children: [myLiveLogs.length, " running"] })] }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: myLiveLogs.map((log) => {
                                                const ro = repairOrders.find((row) => row.id === log.roId);
                                                const line = ro?.workLines.find((row) => row.id === log.workLineId);
                                                return ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line?.title || "Work Line" }), (0, jsx_runtime_1.jsx)("span", { style: styles.statusInfo, children: formatElapsedTime(log.startedAt) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [ro?.roNumber || "-", "  |  ", ro?.plateNumber || ro?.conductionNumber || "-"] }), (0, jsx_runtime_1.jsx)("div", { style: styles.inlineActions, children: (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonDanger, onClick: () => stopWorkLog(log.id), children: "Stop My Timer" }) })] }, log.id));
                                            }) })] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.sectionCard, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sectionTitle, children: "Work Summary" }), (0, jsx_runtime_1.jsx)("div", { style: styles.mobileCardList, children: selectedRO.workLines.map((line) => {
                                                const activeLineLogs = roWorkLogs.filter((log) => log.workLineId === line.id && !log.endedAt);
                                                const lineAssignedTechId = line.assignedTechnicianId || selectedRO.primaryTechnicianId || currentUser.id;
                                                return ((0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCard, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataCardHeader, children: [(0, jsx_runtime_1.jsx)("strong", { children: line.title || "Untitled Work Line" }), (0, jsx_runtime_1.jsx)("span", { style: getWorkLineStatusStyle(line.status), children: line.status })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileDataSecondary, children: [line.category, "  |  Priority ", line.priority] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Assigned Tech" }), (0, jsx_runtime_1.jsx)("strong", { children: lineAssignedTechId ? getUserName(lineAssignedTechId) : "Unassigned" })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Logged Time" }), (0, jsx_runtime_1.jsx)("strong", { children: formatMinutesAsHours(lineMinutesMap.get(line.id) ?? 0) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Service Estimate" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(parseMoneyInput(line.serviceEstimate)) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Parts Estimate" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(parseMoneyInput(line.partsEstimate)) })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.mobileMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Total Estimate" }), (0, jsx_runtime_1.jsx)("strong", { children: formatCurrency(parseMoneyInput(line.totalEstimate)) })] }), line.notes ? (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: line.notes }) : null, activeLineLogs.length ? ((0, jsx_runtime_1.jsxs)("div", { style: styles.formHint, children: ["Live timer: ", activeLineLogs.map((log) => `${getUserName(log.technicianId)} (${formatElapsedTime(log.startedAt)})`).join("  |  ")] })) : null, (0, jsx_runtime_1.jsxs)("div", { style: styles.inlineActions, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButton, onClick: () => {
                                                                        updateWorkLineStatus(line.id, "In Progress");
                                                                        startWorkLog(line.id, lineAssignedTechId);
                                                                    }, children: "Start Line" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonMuted, onClick: () => updateWorkLineStatus(line.id, "Waiting Parts"), children: "Waiting Parts" }), (0, jsx_runtime_1.jsx)("button", { type: "button", style: styles.smallButtonSuccess, onClick: () => markWorkLineComplete(line.id), children: "Mark Complete" })] })] }, line.id));
                                            }) })] })] })) }) })] }) }));
}
function ModulePage({ title, description, currentUser, requiredPermission, roleDefinitions, }) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsx)("div", { style: styles.grid, children: (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsxs)(Card, { title: title, subtitle: "Permission-aware module shell", right: allowed ? (0, jsx_runtime_1.jsx)("span", { style: styles.statusOk, children: "Access Granted" }) : (0, jsx_runtime_1.jsx)("span", { style: styles.statusLocked, children: "Access Blocked" }), children: [(0, jsx_runtime_1.jsx)("div", { style: styles.moduleText, children: description }), (0, jsx_runtime_1.jsxs)("div", { style: styles.moduleMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Required permission:" }), (0, jsx_runtime_1.jsx)("strong", { children: requiredPermission })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.moduleMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Current user:" }), (0, jsx_runtime_1.jsx)("strong", { children: currentUser.fullName })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.moduleMetaRow, children: [(0, jsx_runtime_1.jsx)("span", { children: "Role:" }), (0, jsx_runtime_1.jsx)(RoleBadge, { role: currentUser.role })] })] }) }) }) }));
}
function AppInner() {
    const [roleDefinitions, setRoleDefinitions] = (0, react_1.useState)(() => {
    ...
    const [bookings, setBookings] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.bookings, []));
    const [intakeRecords, setIntakeRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.intakeRecords, []));
    const [inspectionRecords, setInspectionRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.inspectionRecords, []).map(migrateInspectionRecord));
    const [repairOrders, setRepairOrders] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.repairOrders, []).map(migrateRepairOrderRecord));
    const [qcRecords, setQcRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.qcRecords, []));
    const [releaseRecords, setReleaseRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.releaseRecords, []));
    const [partsRequests, setPartsRequests] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.partsRequests, []).map(migratePartsRequestRecord));
    const [approvalRecords, setApprovalRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.approvalRecords, []));
    const [backjobRecords, setBackjobRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.backjobRecords, []).map(migrateBackjobRecord));
    const [invoiceRecords, setInvoiceRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.invoiceRecords, []).map(migrateInvoiceRecord));
    const [paymentRecords, setPaymentRecords] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.paymentRecords, []).map(migratePaymentRecord));
    const [workLogs, setWorkLogs] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.workLogs, []));
    const [customerAccounts, setCustomerAccounts] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.customerAccounts, []));
    const [customerSession, setCustomerSession] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.customerSession, null));
    const [customerPortalMode, setCustomerPortalMode] = (0, react_1.useState)("real");
    const [customerPortalLaunchView, setCustomerPortalLaunchView] = (0, react_1.useState)("dashboard");
    const [customerPortalSharedRoId, setCustomerPortalSharedRoId] = (0, react_1.useState)("");
    const [customerApprovalLinkError, setCustomerApprovalLinkError] = (0, react_1.useState)("");
    const [pendingDemoCustomerPortal, setPendingDemoCustomerPortal] = (0, react_1.useState)(false);
    const [supplierSession, setSupplierSession] = (0, react_1.useState)(null);
    const [approvalLinkTokens, setApprovalLinkTokens] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.approvalLinkTokens, []));
    const [smsApprovalLogs, setSmsApprovalLogs] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.smsApprovalLogs, []));
    const [autoPortalMessage, setAutoPortalMessage] = (0, react_1.useState)("");
    const [loginAudience, setLoginAudience] = (0, react_1.useState)("staff");
    const [customerLoginForm, setCustomerLoginForm] = (0, react_1.useState)({
        identifier: "",
        password: "",
    });
    const [supplierLoginForm, setSupplierLoginForm] = (0, react_1.useState)({
        supplierName: "",
    });
    const [customerLoginError, setCustomerLoginError] = (0, react_1.useState)("");
    const [supplierLoginError, setSupplierLoginError] = (0, react_1.useState)("");
    const [publicBookingForm, setPublicBookingForm] = (0, react_1.useState)(() => ({
        ...getDefaultBookingForm("Book Service"),
        requestedDate: new Date().toISOString().slice(0, 10),
    }));
    const [publicBookingError, setPublicBookingError] = (0, react_1.useState)("");
    const [isSubmittingPublicBooking, setIsSubmittingPublicBooking] = (0, react_1.useState)(false);
    const [currentUser, setCurrentUser] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.session, null));
    const [currentView, setCurrentView] = (0, react_1.useState)(() => readLocalStorage(STORAGE_KEYS.currentView, "dashboard"));
    ...
    const [isMobile, setIsMobile] = (0, react_1.useState)(() => typeof window !== "undefined" ? window.innerWidth < 960 : false);
    (0, react_1.useEffect)(() => {
    ...
    const renderCurrentPage = () => {
        if (!currentUser)
            return null;
        if (!canAccessView(currentUser.role, roleDefinitions, currentView)) {
            return ((0, jsx_runtime_1.jsx)(ModulePage, { title: "Access Restricted", description: "You do not have permission to open this page.", currentUser: currentUser, requiredPermission: "dashboard.view", roleDefinitions: roleDefinitions }));
        }
        switch (currentView) {
            case "dashboard":
                return ((0, jsx_runtime_1.jsx)(DashboardPage, { currentUser: currentUser, users: users, roleDefinitions: roleDefinitions, allowedNav: allowedNav, intakeRecords: intakeRecords, repairOrders: repairOrders, qcRecords: qcRecords, releaseRecords: releaseRecords, approvalRecords: approvalRecords, backjobRecords: backjobRecords, invoiceRecords: invoiceRecords, paymentRecords: paymentRecords, workLogs: workLogs, partsRequests: partsRequests, isCompactLayout: isMobile }));
            case "bookings":
                return ((0, jsx_runtime_1.jsx)(BookingsPage_1.default, { currentUser: currentUser, bookings: bookings, setBookings: setBookings, intakeRecords: intakeRecords, setIntakeRecords: setIntakeRecords, inspectionRecords: inspectionRecords, setInspectionRecords: setInspectionRecords, isCompactLayout: isMobile }));
            case "intake":
                return ((0, jsx_runtime_1.jsx)(IntakePage_1.default, { currentUser: currentUser, intakeRecords: intakeRecords, setIntakeRecords: setIntakeRecords, inspectionRecords: inspectionRecords, setInspectionRecords: setInspectionRecords, isCompactLayout: isMobile }));
            case "users":
                return ((0, jsx_runtime_1.jsx)(UsersPage, { currentUser: currentUser, users: users, setUsers: setUsers, roleDefinitions: roleDefinitions, isCompactLayout: isMobile }));
            case "roles":
                return ((0, jsx_runtime_1.jsx)(RolesPage_1.default, { currentUser: currentUser, roleDefinitions: roleDefinitions, setRoleDefinitions: setRoleDefinitions }));
            case "settings":
                return ((0, jsx_runtime_1.jsx)(SettingsPage_1.default, { currentUser: currentUser, roleDefinitions: roleDefinitions, onResetDefaults: resetRolePermissionsToDefault, onResetIntakes: resetIntakeRecords }));
            case "inspection":
                return ((0, jsx_runtime_1.jsx)(InspectionPage, { currentUser: currentUser, intakeRecords: intakeRecords, inspectionRecords: inspectionRecords, setInspectionRecords: setInspectionRecords, setIntakeRecords: setIntakeRecords, isCompactLayout: isMobile }));
            case "repairOrders":
                return ((0, jsx_runtime_1.jsx)(RepairOrdersPage, { currentUser: currentUser, users: users, intakeRecords: intakeRecords, inspectionRecords: inspectionRecords, repairOrders: repairOrders, setRepairOrders: setRepairOrders, setIntakeRecords: setIntakeRecords, approvalRecords: approvalRecords, setApprovalRecords: setApprovalRecords, backjobRecords: backjobRecords, setBackjobRecords: setBackjobRecords, partsRequests: partsRequests, releaseRecords: releaseRecords, approvalLinkTokens: approvalLinkTokens, autoPortalMessage: autoPortalMessage, smsApprovalLogs: smsApprovalLogs, onGenerateSmsApprovalLink: generateSmsApprovalLink, onOpenDemoCustomerApprovalLink: openDemoCustomerApprovalLink, onSendSmsTemplate: sendSmsTemplate, onRevokeApprovalLink: revokeApprovalLink, isCompactLayout: isMobile }));
            case "shopFloor":
                return ((0, jsx_runtime_1.jsx)(ShopFloorPage, { currentUser: currentUser, users: users, repairOrders: repairOrders, setRepairOrders: setRepairOrders, workLogs: workLogs, setWorkLogs: setWorkLogs, isCompactLayout: isMobile }));
            case "qualityControl":
                return ((0, jsx_runtime_1.jsx)(QualityControlPage_1.default, { currentUser: currentUser, repairOrders: repairOrders, setRepairOrders: setRepairOrders, qcRecords: qcRecords, setQcRecords: setQcRecords, isCompactLayout: isMobile }));
            case "release":
                return ((0, jsx_runtime_1.jsx)(ReleasePage_1.default, { currentUser: currentUser, repairOrders: repairOrders, setRepairOrders: setRepairOrders, qcRecords: qcRecords, releaseRecords: releaseRecords, setReleaseRecords: setReleaseRecords, invoiceRecords: invoiceRecords, setInvoiceRecords: setInvoiceRecords, paymentRecords: paymentRecords, setPaymentRecords: setPaymentRecords, isCompactLayout: isMobile }));
            case "parts":
                return ((0, jsx_runtime_1.jsx)(PartsPage_1.default, { currentUser: currentUser, repairOrders: repairOrders, setRepairOrders: setRepairOrders, partsRequests: partsRequests, setPartsRequests: setPartsRequests, isCompactLayout: isMobile }));
            case "backjobs":
                return ((0, jsx_runtime_1.jsx)(BackjobsPage_1.default, { currentUser: currentUser, users: users, repairOrders: repairOrders, invoiceRecords: invoiceRecords, backjobRecords: backjobRecords, setBackjobRecords: setBackjobRecords, isCompactLayout: isMobile }));
            case "history":
                return ((0, jsx_runtime_1.jsx)(HistoryPage_1.default, { currentUser: currentUser, intakeRecords: intakeRecords, inspectionRecords: inspectionRecords, repairOrders: repairOrders, qcRecords: qcRecords, releaseRecords: releaseRecords, approvalRecords: approvalRecords, backjobRecords: backjobRecords, invoiceRecords: invoiceRecords, paymentRecords: paymentRecords, isCompactLayout: isMobile }));
            default:
                return ((0, jsx_runtime_1.jsx)(DashboardPage, { currentUser: currentUser, users: users, roleDefinitions: roleDefinitions, allowedNav: allowedNav, intakeRecords: intakeRecords, repairOrders: repairOrders, qcRecords: qcRecords, releaseRecords: releaseRecords, approvalRecords: approvalRecords, backjobRecords: backjobRecords, invoiceRecords: invoiceRecords, paymentRecords: paymentRecords, workLogs: workLogs, partsRequests: partsRequests, isCompactLayout: isMobile }));
        }
    };
    if (customerApprovalLinkError) {
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: globalCss }), (0, jsx_runtime_1.jsx)("div", { style: styles.appShell, children: (0, jsx_runtime_1.jsx)("div", { style: styles.mainArea, children: (0, jsx_runtime_1.jsx)("div", { style: styles.pageContent, children: (0, jsx_runtime_1.jsx)("div", { style: styles.grid, children: (0, jsx_runtime_1.jsx)("div", { style: { ...styles.gridItem, gridColumn: "span 12" }, children: (0, jsx_runtime_1.jsxs)(Card, { title: "Customer View", subtitle: "Shared approval link", children: [(0, jsx_runtime_1.jsx)("div", { style: styles.errorBox, children: customerApprovalLinkError }), (0, jsx_runtime_1.jsx)("div", { style: styles.formHint, children: "This shared link is invalid or expired. Please request a fresh customer approval link from the shop." })] }) }) }) }) }) })] }));
    }
    if (customerSession) {
        return ((0, jsx_runtime_1.jsx)(CustomerPortalErrorBoundary, { onReset: handleCustomerLogout, children: (0, jsx_runtime_1.jsx)(CustomerPortalPage, { customer: customerSession, repairOrders: repairOrders, setRepairOrders: setRepairOrders, approvalLinkTokens: approvalLinkTokens, intakeRecords: intakeRecords, inspectionRecords: inspectionRecords, qcRecords: qcRecords, releaseRecords: releaseRecords, approvalRecords: approvalRecords, backjobRecords: backjobRecords, invoiceRecords: invoiceRecords, paymentRecords: paymentRecords, bookings: bookings, setBookings: setBookings, customerAccounts: customerAccounts, setCustomerAccounts: setCustomerAccounts, setCustomerSession: setCustomerSession, onLogout: handleCustomerLogout, isCompactLayout: isMobile, isDemoMode: customerPortalMode === "demo", portalLaunchView: customerPortalLaunchView, sharedLinkRoId: customerPortalSharedRoId, sharedLinkMode: !!customerPortalSharedRoId }) }));
    }
    if (supplierSession) {
        return ((0, jsx_runtime_1.jsx)(SupplierPortalPage, { supplier: supplierSession, partsRequests: partsRequests, setPartsRequests: setPartsRequests, onLogout: handleSupplierLogout, isCompactLayout: isMobile }));
    }
    if (!currentUser) {
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: globalCss }), (0, jsx_runtime_1.jsx)(LoginScreen, { audience: loginAudience, setAudience: setLoginAudience, staffForm: loginForm, setStaffForm: setLoginForm, staffError: loginError, onStaffSubmit: handleLogin, customerForm: customerLoginForm, setCustomerForm: setCustomerLoginForm, customerError: customerLoginError, onCustomerSubmit: handleCustomerLogin, supplierForm: supplierLoginForm, setSupplierForm: setSupplierLoginForm, supplierError: supplierLoginError, onSupplierSubmit: handleSupplierLogin, publicBookingForm: publicBookingForm, setPublicBookingForm: setPublicBookingForm, publicBookingError: publicBookingError, onPublicBookingSubmit: handlePublicBookingSubmit, isPublicBookingSubmitting: isSubmittingPublicBooking, onQuickStaffLogin: quickStaffLogin, onLoadDemoData: loadSimulatedData, onOpenDemoCustomerPortal: openDemoCustomerPortal })] }));
    }
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { children: globalCss }), (0, jsx_runtime_1.jsxs)("div", { style: styles.appShell, children: [isMobile && sidebarOpen ? (0, jsx_runtime_1.jsx)("div", { style: styles.overlay, onClick: () => setSidebarOpen(false) }) : null, (0, jsx_runtime_1.jsxs)("aside", { style: {
                            ...styles.sidebar,
                            ...(isMobile
                                ? sidebarOpen
                        ...
                        }, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.sidebarHeader, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sidebarLogo, children: "DVI" }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.sidebarTitle, children: "Workshop App" }), (0, jsx_runtime_1.jsx)("div", { style: styles.sidebarSubtitle, children: BUILD_VERSION })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.userPanel, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.avatar, children: currentUser.fullName
                                            .split(" ")
                                            .map((part) => part[0] ?? "")
                                            .slice(0, 2)
                                            .join("")
                                            .toUpperCase() }), (0, jsx_runtime_1.jsxs)("div", { style: { minWidth: 0 }, children: [(0, jsx_runtime_1.jsx)("div", { style: styles.userPanelName, children: currentUser.fullName }), (0, jsx_runtime_1.jsx)("div", { style: styles.userPanelRole, children: currentUser.role })] })] }), (0, jsx_runtime_1.jsx)("nav", { style: styles.navList, children: allowedNav.map((item) => {
                                    const active = item.key === currentView;
                                    return ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: () => handleNavigate(item.key), style: { ...styles.navButton, ...(active ? styles.navButtonActive : {}) }, children: [(0, jsx_runtime_1.jsx)("span", { style: styles.navIcon, children: item.icon }), (0, jsx_runtime_1.jsx)("span", { children: item.label })] }, item.key));
                                }) }), (0, jsx_runtime_1.jsx)("div", { style: styles.sidebarFooter, children: (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: handleLogout, style: styles.logoutButton, children: "Sign Out" }) })] }), (0, jsx_runtime_1.jsxs)("div", { style: { ...styles.mainArea, marginLeft: isMobile ? 0 : 280 }, children: [(0, jsx_runtime_1.jsxs)("header", { style: styles.topBar, children: [(0, jsx_runtime_1.jsxs)("div", { style: styles.topBarLeft, children: [isMobile ? ((0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => setSidebarOpen((prev) => !prev), style: styles.menuButton, children: "\u00E2\u02DC\u00B0" })) : null, (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { style: styles.pageTitle, children: currentNavItem.label }), (0, jsx_runtime_1.jsx)("div", { style: styles.pageSubtitle, children: BUILD_VERSION })] })] }), (0, jsx_runtime_1.jsxs)("div", { style: styles.topBarRight, children: [(0, jsx_runtime_1.jsx)(RoleBadge, { role: currentUser.role }), (0, jsx_runtime_1.jsx)("div", { style: styles.topBarName, children: currentUser.fullName })] })] }), (0, jsx_runtime_1.jsx)("main", { style: styles.mainContent, children: renderCurrentPage() })] })] })] }));
}
function App() {
    return ((0, jsx_runtime_1.jsx)(AppErrorBoundary, { children: (0, jsx_runtime_1.jsx)(AppInner, {}) }));
}
const globalCss = `
